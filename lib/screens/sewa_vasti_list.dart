  ...
  Future<List<dynamic>> _getSewaVastiLst(int? mahanagar,int? vibhag,int? bhag,int? nagar, int? vasti, int? gram,int? manadal, int? sewaVastiID, int? geounitID) async {
    ...
    if (isConnected) {
      String strInput = json.encode(
          {"AppUserID": Statics.userDetails['userID'], "MahanagarID ": mahanagar, "VibhaagID ": vibhag, "BhaagID": bhag, "ShaharID": _shaharValue, "NagarID": nagar, "VastiID ": vasti, "GraamID": gram, "MandalID ": manadal, "SewaVastiID": sewaVastiID,"GeoUnitId":geounitID });
        ...
        appBar: AppBar(
          ...
          actions: <Widget>[
            ...
            (Statics.userDetails['LevelName'] == 'Praant' ||
                ...
                Statics.userDetails['LevelName'] == 'विभाग' ||Statics.userDetails["LevelName"] == "Bhaag" ||Statics.userDetails["LevelName"] == "भाग/जिला" ||Statics.userDetails["LevelName"] == "भाग/जिल्हा")
                &&
