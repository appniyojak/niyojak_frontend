...
//------ Blood Group - count-------------------------------------------------//
  ...
  Future<void> populateDropdown({bool fromClear = false}) async {
    setState(() {
      ...
      _selctedLevel = _selectedGeoUnitId = null;
