...
class _AnnualBaithakEkatritVruttaState extends State<AnnualBaithakEkatritVrutta> {
  ...
  Future<void> _search() async {
    ...
    geoID = (nagarVal != null
        ? nagarVal
        : (bhaagVal != null ? bhaagVal : (vibhaagVal != null ? vibhaagVal : (mahaanagarVal != null ? mahaanagarVal : null))));
...
// Calculate the number of pages needed
  ...
  Future<void> redirctToList(
      String? type, String? annualBaithakTypeID, int? geoUnitID, String? infoName) async {
    showDialog(
      context: context,
                    ...
                    Wrap(
                      children: [
                        ...
                        MaterialButton(
                            onPressed: () {
                              setState(() {
                                mahanagarId =   _linkedMahaanagarValue = _linkedVibhaagValue =
                                    _linkedBhaagValue = _linkedShaharValue = _linkedNagarValue  = _baithakType = null;
                      ...
                      children: [
                        ...
                        //     child:
                          ...
                          children: [
                            ...
                            SingleColumnRow(txtString: Statics.getLabel('mahaanagar') + ':-', value: '', fontsize: 18,view: true,btnAction:() {
...
// ==================================  ANYA NAGAR ==============================================================
                        ...
                        //     child:
                          ...
                          children: [
                            ...
                            SingleColumnRow(txtString: Statics.getLabel('anyaNagar') + ':-', value: '', fontsize: 18,view: true,btnAction:() {
                            ...
                            SingleColumnRow(txtString: "एकूण " + Statics.getLabel('nagarCount').split(" ").first + ':-', value: '', fontsize: 18,view: true,btnAction:() {
                            ...
                            NewFiveColumnRow(
                              ...
                              value4:"${(int.parse(_ekatritVrutta['AnyaNagarMin2ShaakhaaYuktaNagarCount'].toString()) + int.parse(_ekatritVrutta['MahaanagarMin2ShaakhaaYuktaNagarCount'].toString()))}",
                            ...
                            SingleColumnRow(txtString: Statics.getLabel('graaminTaaluka') + ':-', value: '', fontsize: 18,view: true,btnAction:() {
                            ...
                            SingleColumnRow(txtString: 'मंडळ:-', value: '', fontsize: 18,view: true,btnAction:() {
                            ...
                            SingleColumnRow(txtString: "एकूण " + Statics.getLabel('vastiCount').split(" ").first + ':-', value: '', fontsize: 18,view: true,btnAction:() {
                            ...
                            NewFourColumnRow(
                              ...
                              txtString3: "एकूण\nमंडळीयुक्त वस्ती",
                              value3: (int.parse(_ekatritVrutta['AnyaNagarMaasikYuktaVastiCount'].toString()) +
                                  int.parse(_ekatritVrutta['MahaanagarMaasikYuktaVastiCount'].toString()))
                                  .toString(),
                              txtString4: "एकूण\n" + Statics.getLabel('samparkYuktaVasti'),
                              value4: (int.parse(_ekatritVrutta['AnyaNagarSamparkYuktaVastiCount'].toString()) +
                                  int.parse(_ekatritVrutta['MahaanagarSamparkYuktaVastiCount'].toString()))
                                  .toString(),
                              fontsize: 15,
                            ),
                            Container(
                            ...
                            SingleColumnRow(txtString:Statics.getLabel('sthaan') + ':-', value: '', fontsize: 18,view: true,btnAction:() {
                            ...
                            NewThreeColumnRow(
                              ...
                              txtString3: 'एकूण\nनगरीय स्थान',
                              value3: (int.parse(_ekatritVrutta['AnyaNagarShaakhaaYuktaNagarCount'].toString()) +
                                  int.parse(_ekatritVrutta['MahaanagarShaakhaaYuktaNagarCount'].toString()))
                                  .toString(),
                            ),
                            Container(width: Statics.getDeviceSize(context).width,child: Divider(color: Colors.black,),),
                            NewThreeColumnRow(
                  ...
                  // ),
                        ...
                        SingleColumnRowLegend(txtString: Statics.getLabel('sewaVrutta') + ' :', value: '', fontsize: 18,view: true,btnAction:() {
                        ...
                        SingleColumnRow(
                            ...
                            fontsize: 15),
                        SingleColumnRow(
                            txtString: Statics.getLabel('anyaUpakramShaakhaaCount'),
                            value: _ekatritVrutta['AnyaUpakramShaakhaaCount'].toString(),
                            fontsize: 15),
                        SingleColumnRow(txtString: 'एकूण', value: _ekatritVrutta['TotalUpakramShaakhaaCount'].toString(), fontsize: 15),
                        SizedBox(height: 20,),
                        // Legend(legendString: "sewaVrutta", fontsize: 18),
                        SingleColumnRow(
                            txtString: Statics.getLabel('sewaVastiIdentifiedShaakhaaCount'),
                            value: _ekatritVrutta['SewaVastiIdentifiedShaakhaaCount'].toString(),
                            fontsize: 15),
                        SingleColumnRow(
                            txtString: Statics.getLabel('sevaPramukhIdentifiedShaakhaaCount'),
                            value: _ekatritVrutta['SewaPramukhIdentifiedShaakhaaCount'].toString(),
                            fontsize: 15),
                        SingleColumnRow(
                            txtString: (_baithakType == Statics.abPratinidhiSabhaa
...
// =============================================================sewa Vasti Sampark Shaakhaa Count===================================================================================================================
                        ...
                        SingleColumnRow(txtString: Statics.getLabel('sewaVastiSamparkShaakhaaCount') + ':-', value: '', fontsize: 18,),
...
//                         ),
                      Column(
                          ...
                          Center(
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Flexible(
                                    child: Text(Statics.getLabel('shakhaJilhaKendra'), textAlign: TextAlign.left,style: TextStyle(color: Colors.purple, fontSize:  18 , fontWeight: FontWeight.w600),),
                                  ),
                                  IconButton(onPressed: (){
                                    redirctToList("kiman5ShakhaJilaKendra",_baithakType.toString(),geoID ,Statics.getLabel('shakhaJilhaKendra'));

                                  }, icon: Icon(FontAwesomeIcons.list,color: Colors.purpleAccent,size: 20,)),
                                ],
                              ),
                            ),
                          ),
                        ...
                        SingleColumnRow(txtString: Statics.getLabel('Total'), value: "${_ekatritVrutta['shakhaJilhaKendra'].toString()=="null"? "0":_ekatritVrutta['shakhaJilhaKendra'].toString()}".toString(), fontsize: 15),
                          ...
                          children: [
                                ...
                                Center(
                                  child: Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Flexible(
                                          child: Text(Statics.getLabel('vartamaanAndSankalp'), textAlign: TextAlign.left,style: TextStyle(color: Colors.purple, fontSize:  18 , fontWeight: FontWeight.w600),),
                                        ),
                                        IconButton(onPressed: (){
                            ...
                            Table(
                              ...
                              children: [
                                TableRow(
                                  children: [
                                    Container(height: 40,child: Text(Statics.getLabel('vruttaPrakaar'),style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18),)),
                                ...
                                TableRow(children: [
                                  ...
                                  Text(_ekatritVrutta['PoornaJilhaKendraCount'].toString(),style: TextStyle(fontSize: 15),),
                                  Text(_ekatritVrutta['SankalpaPoornaJilhaKendraCount'].toString(),style: TextStyle(fontSize: 15),),
                                ]),
                                TableRow(children: [
                                  Text(Statics.getLabel('poornaJilha')),
                                  Text(_ekatritVrutta['PoornaJilhaCount'].toString(),style: TextStyle(fontSize: 15),),
                                  Text(_ekatritVrutta['SankalpaPoornaJilhaCount'].toString(),style: TextStyle(fontSize: 15),
                                  ),
                                ]),
                                TableRow(children: [
                                  Text(''),
                                ...
                                TableRow(children: [
                                  ...
                                  Text(_ekatritVrutta['JilhaWithPoornaTaalukaaCount'].toString(),style: TextStyle(fontSize: 15),),
                                  Text(_ekatritVrutta['SankalpaJilhaWithPoornaTaalukaaCount'].toString(),style: TextStyle(fontSize: 15),),
                                ]),
                                TableRow(children: [
                                  Text(Statics.getLabel('unJilhokeKulTaalukaa')),
                                  Text(_ekatritVrutta['TotalTaalukaaCountOfJilhaWithPoornaTaalukaa'].toString(),style: TextStyle(fontSize: 15),),
                                  Text(_ekatritVrutta['SankalpaTotalTaalukaaCountOfJilhaWithPoornaTaalukaa'].toString(),style: TextStyle(fontSize: 15),),
                                ]),
                                TableRow(children: [
                                  Text(Statics.getLabel('poornaTaaluka')),
                                  Text(_ekatritVrutta['PoornaTaalukaaCount'].toString(),style: TextStyle(fontSize: 15),),
                                  Text(_ekatritVrutta['SankalpaPoornaTaalukaaCount'].toString(),style: TextStyle(fontSize: 15),),
                                ]),
                                TableRow(children: [
                                  Text(''),
                                  Text(''),
                                ...
                                TableRow(children: [
                                  Text(Statics.getLabel('poornaMandal'),style: TextStyle(fontSize: 18),),
                                  Text('',style: TextStyle(fontSize: 15),),
                                  Text('',style: TextStyle(fontSize: 15),),
                                ]),
                                TableRow(children: [
                                  Text(Statics.getLabel('kitaneTaalukaaoMe')),
                                  Text(_ekatritVrutta['TaalukaaWithPoornaMandalCount'].toString(),style: TextStyle(fontSize: 15),),
                                  Text(_ekatritVrutta['SankalpaTaalukaaWithPoornaMandalCount'].toString(),style: TextStyle(fontSize: 15),),
                                ]),
                                TableRow(children: [
                                  Text(Statics.getLabel('poornaMandal')),
                                  Text(_ekatritVrutta['PoornaMandalCount'].toString(),style: TextStyle(fontSize: 15),),
                                  Text(_ekatritVrutta['SankalpaPoornaMandalCount'].toString(),style: TextStyle(fontSize: 15),),
                                ]),
                                TableRow(children: [
                                  Text(''),
                                  Text(''),
...
// =============================================    PURNA  NAGAR         =======================================================================================================================================
                  ...
                  TableRow(children: [
                                ...
                                TableRow(children: [
                                  ...
                                  Text(_ekatritVrutta['JilhaWithPoornana'
                                      'arCount'] == null ?"0":_ekatritVrutta['JilhaWithPoornana'
                                      'arCount'].toString(),style: TextStyle(fontSize: 15),),
                                  Text(_ekatritVrutta['SankalpaJilhaWithPoornanagarCount'].toString(),style: TextStyle(fontSize: 15),),
                                ]),
                                TableRow(children: [
                                  Text(Statics.getLabel('unNagarkeKulTaalukaa')),
                                  Text(_ekatritVrutta['TotalnagarCountOfJilhaWithPoornanagar'].toString(),style: TextStyle(fontSize: 15),),
                                  Text(_ekatritVrutta['SankalpaTotalnagarCountOfJilhaWithPoornanagar'].toString(),style: TextStyle(fontSize: 15),),
                                ]),
                                TableRow(children: [
                                  Text(Statics.getLabel('poornaNagar')),
                                  Text(_ekatritVrutta['PoornanagarCount'].toString(),style: TextStyle(fontSize: 15),),
                                  Text(_ekatritVrutta['SankalpaPoornanagarCount'].toString(),style: TextStyle(fontSize: 15),),
                                ]),
                                TableRow(children: [
                                  Text(''),
                                  Text(''),
                        ...
                        if (_baithakType != null && _baithakType == Statics.abPratinidhiSabhaa)
                          Column(
                            children: <Widget>[
                              ...
                              SingleColumnRow(
                                  txtString: Statics.getLabel('mukhyaMaargCount'), value: _ekatritVrutta['MukhyaMaargCount'].toString(), fontsize: 15),
                              SingleColumnRow(
                                  txtString: Statics.getLabel('graamPramukhCount'),
                                  value: _ekatritVrutta['MukhyaMaargGraamPramukhCount'].toString(),
                                  fontsize: 15),
                              SingleColumnRow(
                                  txtString: Statics.getLabel('mukhyaMaargGraamCount'),
                                  value: _ekatritVrutta['MukhyaMaargGraamCount'].toString(),
                                  fontsize: 15),
                              SingleColumnRow(
                                  txtString: Statics.getLabel('mukhyaMaargShaakhaaYuktaGraamCount'),
                                  value: _ekatritVrutta['MukhyaMaargShaakhaaYuktaGraamCount'].toString(),
                                  fontsize: 15),
                              SingleColumnRow(
                                  txtString: Statics.getLabel('mukhyaMaargSaaptaahikYuktaGraamCount'),
                                  value: _ekatritVrutta['MukhyaMaargSaaptaahikYuktaGraamCount'].toString(),
                                  fontsize: 15),
                              SingleColumnRow(
                                  ...
                                  fontsize: 15),
                              SingleColumnRow(
                                  txtString: Statics.getLabel('mukhyaMaargRemainingGraamCount'),
                                  value: _ekatritVrutta['MukhyaMaargRemainingGraamCount'].toString(),
                                  fontsize: 15),
                              SingleColumnRow(
                                  txtString: Statics.getLabel('pastShaakhaaGraamCount'),
                                  value: _ekatritVrutta['MukhyaMaargPastShaakhaaGraamCount'].toString(),
                                  fontsize: 15),
                              SizedBox(
                                height: 20,
                              ),
                        ...
                        if (_baithakType != null && _baithakType == Statics.abPratinidhiSabhaa)
                          Column(
                            children: <Widget>[
                              ...
                              SingleColumnRow(
                                  txtString: Statics.getLabel('prashikshitShikshaarthi'),
                                  value: _ekatritVrutta['PrathamGeneralShikshaarthiCount'].toString(),
                                  fontsize: 15),
                              SingleColumnRow(
                                  txtString: Statics.getLabel('sthaan'), value: _ekatritVrutta['PrathamGeneralSthaanCount'].toString(), fontsize: 15),
                              SingleColumnRow(
                                  txtString: Statics.getLabel('taalukaa'), value: _ekatritVrutta['PrathamGeneralTaalukaaCount'].toString(), fontsize: 15),
                              SizedBox(
                                height: 10,
                              ),
                              ...
                              SingleColumnRow(
                                  txtString: Statics.getLabel('prashikshitShikshaarthi'),
                                  value: _ekatritVrutta['DwitiyaGeneralShikshaarthiCount'].toString(),
                                  fontsize: 15),
                              SingleColumnRow(
                                  txtString: Statics.getLabel('sthaan'), value: _ekatritVrutta['DwitiyaGeneralSthaanCount'].toString(), fontsize: 15),
                              SingleColumnRow(
                                  txtString: Statics.getLabel('jilha'), value: _ekatritVrutta['DwitiyaGeneralJilhaCount'].toString(), fontsize: 15),
                              SizedBox(
                                height: 10,
                              ),
                              ...
                              SingleColumnRow(
                                  txtString: Statics.getLabel('prashikshitShikshaarthi'),
                                  value: _ekatritVrutta['TrutiyaGeneralShikshaarthiCount'].toString(),
                                  fontsize: 15),
                              SingleColumnRow(
                                  txtString: Statics.getLabel('sthaan'), value: _ekatritVrutta['TrutiyaGeneralSthaanCount'].toString(), fontsize: 15),
                              SingleColumnRow(
                                  txtString: Statics.getLabel('vibhaag'), value: _ekatritVrutta['TrutiyaGeneralVibhaagCount'].toString(), fontsize: 15),
                              SizedBox(
                                height: 10,
                              ),
                              ...
                              SingleColumnRow(
                                  txtString: Statics.getLabel('prashikshitShikshaarthi'),
                                  value: _ekatritVrutta['PrathamSpecialShikshaarthiCount'].toString(),
                                  fontsize: 15),
                              SingleColumnRow(
                                  txtString: Statics.getLabel('sthaan'), value: _ekatritVrutta['PrathamSpecialSthaanCount'].toString(), fontsize: 15),
                              SizedBox(
                                height: 20,
                              ),
                            ],
...
//                         Legend(legendString: "kaaryaSthitiSankhyaatmak", fontsize: 18),
                        SingleColumnRowLegend(txtString: Statics.getLabel('kaaryaSthitiSankhyaatmak') + ' :', value: '', fontsize: 18,view: true,btnAction:() {
                         ...
                         Table(
                                ...
                                children: [
                                  TableRow(
                                    children: [
                                      Container(height: 40,child: Text('वयोगट',style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),)),
                                      ...
                                      Container(height: 40,child: Text(Statics.getLabel('TotalSankalpitShaakhaa'),textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16))),
                                  ...
                                  TableRow(children: [
                                    ...
                                    Text(_ekatritVrutta['BaalSahaakhaaCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                                    // Text(_ekatritVrutta['SankalpaBaalSahaakhaaCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                                    Text(_ekatritVrutta['BaalTotalSankalpitShaakhaCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                                  ...
                                  TableRow(children: [
                                    ...
                                    Text(_ekatritVrutta['TarunVidyaarthiShaakhaaCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                                    // Text(_ekatritVrutta['SankalpaTarunVidyaarthiShaakhaaCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                                    Text(_ekatritVrutta['MahavidyalayinTotalSankalpitShaakhaCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                                  ...
                                  TableRow(children: [
                                    ...
                                    Text(_ekatritVrutta['TarunVyavasaayeeShaakhaaCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                                    ...
                                    Text(_ekatritVrutta['TarunTotalSankalpitShaakhaCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                                  ...
                                  TableRow(children: [
                                    ...
                                    Text(_ekatritVrutta['ProudhShaakhaaCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                                    // Text(_ekatritVrutta['SankalpaProudhShaakhaaCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                                    Text(_ekatritVrutta['ProudhTotalSankalpitShaakhaCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                                  ...
                                  TableRow(children: [
                                    Text('एकूण', style: TextStyle(fontSize: 15)),
                                    Text(_ekatritVrutta['TotalShaakhaaCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                                    // Text(_ekatritVrutta['SankalpaTotalShaakhaaCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                                    Text(_ekatritVrutta['AllVayogatTotalSankalpitShaakhaCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
...
// ==============================================================   average Upasthiti Shaakhaa  ======================================================================================================
                        ...
                        SizedBox(height: 5,),
                        SingleColumnRow(txtString: Statics.getLabel('averageBaal'), value: _ekatritVrutta['BaalAverageShaakhaa'].toString() =="null"?"0": _ekatritVrutta['BaalAverageShaakhaa'].toString(), fontsize: 15),
                        SizedBox(height: 5,),
                        SingleColumnRow(txtString: Statics.getLabel('averageMahavidyaalayeen'),value: _ekatritVrutta['TarunVidyaarthiAverageShaakhaa'].toString() =="null"?"0": _ekatritVrutta['TarunVidyaarthiAverageShaakhaa'].toString(),fontsize: 15),
                        SizedBox(height: 5,),
                        SingleColumnRow(txtString: Statics.getLabel('averageTarunVyavasaayee'),value: _ekatritVrutta['TarunVyavasaayeeAverageShaakhaa'].toString() =="null"?"0": _ekatritVrutta['TarunVyavasaayeeAverageShaakhaa'].toString(),fontsize: 15),
                        SizedBox(height: 5,),
                        SingleColumnRow(txtString: Statics.getLabel('averageProudh'), value: _ekatritVrutta['ProudhAverageShaakhaa'].toString() =="null"?"0": _ekatritVrutta['ProudhAverageShaakhaa'].toString(), fontsize: 15),
                        SizedBox(height: 5,),
                        SingleColumnRow(txtString: 'शिशु', value: _ekatritVrutta['ShishuAverageShaakhaa'].toString() =="null"?"0": _ekatritVrutta['ShishuAverageShaakhaa'].toString(), fontsize: 15),
                        SizedBox(height: 5,),
                        SingleColumnRow(txtString: 'एकूण', value: _ekatritVrutta['TotalAverageShaakhaa'].toString() =="null"?"0": _ekatritVrutta['TotalAverageShaakhaa'].toString(), fontsize: 15),
                        SizedBox(height: 25,),
                          ...
                          children: [
                            TableRow(
                              children: [
                                Container(
                                    height: 40,
                                    child: Text('वयोगट',style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),)),
                                Container(height: 40,child:Text('सध्या स्थिती', textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16))),
                            ...
                            TableRow(children: [
                              Text(Statics.getLabel('baalSanyukt'), style: TextStyle(fontSize: 15)),
                              Text(_ekatritVrutta['NagariyaBaalSaaptaahikCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                              Text(_ekatritVrutta['SankalpaNagariyaBaalSaaptaahikCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                            ]),
                            TableRow(children: [
                              Text(Statics.getLabel('mahaavidyaalayeen'), style: TextStyle(fontSize: 15)),
                              Text(_ekatritVrutta['NagariyaTarunVidyaarthiSaaptaahikCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                              Text(_ekatritVrutta['SankalpaNagariyaTarunVidyaarthiSaaptaahikCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                            ]),
                            TableRow(children: [
                              Text(Statics.getLabel('vyavasaayeeTarun'), style: TextStyle(fontSize: 15)),
                              Text(
                                _ekatritVrutta['NagariyaTarunVyavasaayeeSaaptaahikCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                              Text(_ekatritVrutta['SankalpaNagariyaTarunVyavasaayeeSaaptaahikCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                            ]),
                            TableRow(children: [
                              Text(Statics.getLabel('proudhVyavasaayee'), style: TextStyle(fontSize: 15)),
                              Text(_ekatritVrutta['NagariyaProudhSaaptaahikCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                              Text(_ekatritVrutta['SankalpaNagariyaProudhSaaptaahikCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                            ]),
                            TableRow(children: [
                              Text('एकूण', style: TextStyle(fontSize: 15)),
                              Text(_ekatritVrutta['NagariyaTotalSaaptaahikCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                              Text(_ekatritVrutta['SankalpaNagariyaTotalSaaptaahikCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                            ]),
                          ],
                        ),
                        SizedBox(height: 28,),
                      ...
                      //     child:
                        ...
                        // Legend(legendString: "graaminSaaptaahik", fontsize: 18),
                            SingleColumnRowLegend(txtString: Statics.getLabel('graaminSaaptaahikSthan'), value: '', fontsize: 18,view: true,btnAction:() {
                        ...
                        SizedBox(height: 25,),
                            ...
                            SingleColumnRowLegend(txtString: Statics.getLabel('TotalSaaptaahikMilan'), value: '', fontsize: 18,view: true,btnAction:() {
                            ...
                            Table(
                              ...
                              children: [
                                TableRow(children: [
                                    ...
                                    Container(height: 40,child:Text('सध्या स्थिती', textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16))),
                                    // Container(height: 40,child: Text(Statics.getLabel('sankalp'),textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16))),
                                    Container(height: 40,child: Text(Statics.getLabel('TotalSankalpitSaaptaahikMilan'),textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16))),
                                  ]),
                                TableRow(children: [
                                  Text(Statics.getLabel('baalSanyukt'), style: TextStyle(fontSize: 15)),
                                  Text(((_ekatritVrutta['NagariyaBaalSaaptaahikCount'])+ _ekatritVrutta['GraaminBaalSaaptaahikCount']).toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                                  ...
                                  Text(_ekatritVrutta['BaalTotalSankalpitSaptahikMilanCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                                ]),
                                TableRow(children: [
                                  Text(Statics.getLabel('mahaavidyaalayeen'), style: TextStyle(fontSize: 15)),
                                  Text(((_ekatritVrutta['NagariyaTarunVidyaarthiSaaptaahikCount'])+ _ekatritVrutta['GraaminTarunVidyaarthiSaaptaahikCount']).toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                                  ...
                                  Text(_ekatritVrutta['MahavidyalayinTotalSankalpitSaptahikMilanCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                                ]),
                                TableRow(children: [
                                  Text(Statics.getLabel('vyavasaayeeTarun'), style: TextStyle(fontSize: 15)),
                                  Text(((_ekatritVrutta['NagariyaTarunVyavasaayeeSaaptaahikCount'])+ _ekatritVrutta['GraaminTarunVyavasaayeeSaaptaahikCount']).toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                                  ...
                                  Text(_ekatritVrutta['TarunTotalSankalpitSaptahikMilanCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                                ]),
                                TableRow(children: [
                                  Text(Statics.getLabel('proudhVyavasaayee'), style: TextStyle(fontSize: 15)),
                                  Text(((_ekatritVrutta['NagariyaProudhSaaptaahikCount'])+ _ekatritVrutta['GraaminProudhSaaptaahikCount']).toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                                  ...
                                  Text(_ekatritVrutta['ProudhTotalSankalpitSaptahikMilanCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                                ]),
                                TableRow(children: [
                                  Text('एकूण', style: TextStyle(fontSize: 15)),
                                  Text(((_ekatritVrutta['NagariyaTotalSaaptaahikCount'])+ _ekatritVrutta['GraaminTotalSaaptaahikCount']).toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                                  ...
                                  Text(_ekatritVrutta['AllVayogatTotalSankalpitSaptahikMilanCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                                ]),
                              ],
                            ),
                            SizedBox(height: 20,),
                      ...
                      // ),
                        ...
                        SingleColumnRow(txtString: Statics.getLabel('averageBaal'), value: _ekatritVrutta['BaalAverageNagariyaSaaptaahik'].toString() == "null"?"0":_ekatritVrutta['BaalAverageNagariyaSaaptaahik'].toString(), fontsize: 15),
                        ...
                        SingleColumnRow(txtString: 'एकूण', value: _ekatritVrutta['TotalAverageNagariyaSaaptaahik'].toString(), fontsize: 15),
                        SizedBox(height: 20,),
                       ...
                       //     child:
                           ...
                           SingleColumnRow(txtString: Statics.getLabel('averageBaal'), value: _ekatritVrutta['BaalAverageGraaminSaaptaahik'].toString() =="null"?"0": _ekatritVrutta['BaalAverageGraaminSaaptaahik'].toString(), fontsize: 15),
                           SingleColumnRow(txtString: Statics.getLabel('averageMahavidyaalayeen'),value:_ekatritVrutta['TarunVidyaarthiAverageGraaminSaaptaahik'].toString() =="null"?"0": _ekatritVrutta['TarunVidyaarthiAverageGraaminSaaptaahik'].toString(),fontsize: 15),
                           SingleColumnRow(txtString: Statics.getLabel('averageTarunVyavasaayee'),value:_ekatritVrutta['TarunVyavasaayeeAverageGraaminSaaptaahik'].toString() =="null"?"0": _ekatritVrutta['TarunVyavasaayeeAverageGraaminSaaptaahik'].toString(),fontsize: 15),
                           SingleColumnRow(txtString: Statics.getLabel('averageProudh'),value:_ekatritVrutta['ProudhAverageGraaminSaaptaahik'].toString() =="null"?"0": _ekatritVrutta['ProudhAverageGraaminSaaptaahik'].toString(),fontsize: 15),
                           SingleColumnRow(txtString: 'शिशु', value:_ekatritVrutta['ShishuAverageGraaminSaaptaahik'].toString() =="null"?"0": _ekatritVrutta['ShishuAverageGraaminSaaptaahik'].toString(), fontsize: 15),
                           SingleColumnRow(txtString: 'एकूण', value:_ekatritVrutta['TotalAverageGraaminSaaptaahik'].toString() =="null"?"0": _ekatritVrutta['TotalAverageGraaminSaaptaahik'].toString(), fontsize: 15),
                           SizedBox(height: 20,),
                         ]),
                       // ),
// ================================================  Maasik Milan  ====================================================================================
                        ...
                        SingleColumnRowLegend(txtString: Statics.getLabel('MaasikMilan') + ':', value: '', fontsize: 18,view: true,btnAction:() {
                          ...
                          children: [
                            TableRow(
                              children: [
                                ...
                                Container(height: 40,child:Text('सध्या स्थिती', textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16))),
                                // Container(height: 40,child: Text(Statics.getLabel('sankalp'),textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16))),
                                Container(height: 40,child: Text(Statics.getLabel('TotalSankalpitMasikMilan'),textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16))),
                              ],
                            ),
                            TableRow(
                                children: [
                                  ...
                                  Text(_ekatritVrutta['MaasikMilanSankalpaVidyaarthiMaasikCount'].toString()
                            ...
                            TableRow(
                              ...
                              Text(_ekatritVrutta['MaasikMilanSankalpaVyavasaayeeMaasikCount'].toString()
...
// ================================================  Sangha Mandali  ================================================
                        ...
                        SingleColumnRowLegend(txtString: Statics.getLabel('SanghaMandali') + ':', value: '', fontsize: 18,view: true,btnAction:() {
                        ...
                        Table(
                          ...
                          children: [
                            ...
                            TableRow(children: [
                              Text(Statics.getLabel('vidyaarthi'), style: TextStyle(fontSize: 15)),
                              Text(_ekatritVrutta['SanghMandaliVidyaarthiMaasikCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                              ...
                              Text("${_ekatritVrutta['SanghMandaliSankalpaVidyaarthiMaasikCount']}",textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                            ]),
                            TableRow(children: [
                              Text(Statics.getLabel('vyavasaayee'), style: TextStyle(fontSize: 15)),
                              Text(_ekatritVrutta['SanghMandaliVyavasaayeeMaasikCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                              ...
                              Text("${_ekatritVrutta['SanghMandaliSankalpaVyavasaayeeMaasikCount']}",textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                            ]),
                            TableRow(children: [
                              Text('एकूण', style: TextStyle(fontSize: 15)),
                              Text(_ekatritVrutta['SanghMandaliTotalMaasikCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                              // Text(_ekatritVrutta['SanghMandaliSankalpaTotalMaasikCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                              Text("${_ekatritVrutta['SanghMandaliSankalpaVyavasaayeeMaasikCount']+_ekatritVrutta['SanghMandaliSankalpaVidyaarthiMaasikCount']}",textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                            ]),
                          ],
                        ),
                        SizedBox(height: 20,),
// ================================================  Mandali Sthan  ================================================
                        ...
                        Table(
                          ...
                          children: [
                            ...
                            TableRow(children: [
                              Text(Statics.getLabel('vidyaarthi'), style: TextStyle(fontSize: 15)),
                              Text(_ekatritVrutta['MandaliSthanVidyaarthiMaasikCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                              Text(_ekatritVrutta['MandaliSthanSankalpaVidyaarthiMaasikCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                            ]),
                            TableRow(children: [
                              Text(Statics.getLabel('vyavasaayee'), style: TextStyle(fontSize: 15)),
                              Text(_ekatritVrutta['MandaliSthanVyavasaayeeMaasikCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                              Text(_ekatritVrutta['MandaliSthanSankalpaVyavasaayeeMaasikCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                            ]),
                            TableRow(children: [
                              Text('एकूण', style: TextStyle(fontSize: 15)),
                              Text(_ekatritVrutta['MandaliSthanTotalMaasikCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                              Text(_ekatritVrutta['MandaliSthanSankalpaTotalMaasikCount'].toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 15),),
                            ]),
                          ],
                        ),
                        SizedBox(height: 20,),
...
//                         Legend(legendString: 'shaakhaaToli', fontsize: 18),
                        SingleColumnRowLegend(txtString: Statics.getLabel('shaakhaaToli') + ':', value: '', fontsize: 18,view: true,btnAction:() {
                        ...
                        SingleColumnRow(txtString: 'एकूण', value: _ekatritVrutta['TotalShaakhaaToliYuktaCount'].toString(), fontsize: 15),
                        SizedBox(height: 20,),
// =====================================  SAptahik MIlan Toli  =======================================================
//                         Legend(legendString: 'saptahikMilanToli', fontsize: 18),
                                                SingleColumnRowLegend(txtString: Statics.getLabel('saptahikMilanToli') + ':', value: '', fontsize: 18,view: true,btnAction:() {
                          redirctToList("saptahikMilanToli",_baithakType.toString(),geoID ,Statics.getLabel('saptahikMilanToli'));
                        }),
                        SingleColumnRow(txtString: Statics.getLabel('baalSanyukt'), value: _ekatritVrutta['BalSaaptaahikMilanToliCount'].toString() == "null"?"0": _ekatritVrutta['BalSaaptaahikMilanToliCount'].toString(), fontsize: 15),
                        SingleColumnRow(txtString: Statics.getLabel('mahaavidyaalayeen'),value: _ekatritVrutta['TarunSaaptaahikMilanToliCount'].toString() == "null"?"0":  _ekatritVrutta['TarunSaaptaahikMilanToliCount'].toString(),fontsize: 15),
                        ...
                        SingleColumnRow(txtString: 'एकूण', value: _ekatritVrutta['TotalSaaptaahikMilanToliCount'].toString(), fontsize: 15),
                        SizedBox(height: 20,),
// =====================================     Baithak karnara shakha  =======================================================

                        // Legend(legendString: 'baithakKrnaraShakha', fontsize: 18),
                        SingleColumnRowLegend(txtString: Statics.getLabel('baithakKrnaraShakha') + ':', value: '', fontsize: 18,view: true,btnAction:() {
                        ...
                        SingleColumnRow(txtString: 'एकूण', value: _ekatritVrutta['TotalBaithakShaakhaaCount'].toString(), fontsize: 15),
                        SizedBox(height: 20,),
                        ...
                        if (_baithakType != null && _baithakType == Statics.abPratinidhiSabhaa)
                          Column(
                            children: <Widget>[
                              ...
                              SingleColumnRow(
                                  txtString: Statics.getLabel('graamVikasGraamCount'), value: _ekatritVrutta['GraamVikasCount'].toString(), fontsize: 15),
                              SingleColumnRow(
                                  txtString: Statics.getLabel('udayGraamCount'), value: _ekatritVrutta['UdayGraamCount'].toString(), fontsize: 15),
                              SingleColumnRow(
                                  txtString: Statics.getLabel('prabhaatGraamCount'),
                                  value: _ekatritVrutta['PrabhaatGraamCount'].toString(),
                                  fontsize: 15),
                              SizedBox(
                                height: 20,
                              ),
                        ...
                        if (_baithakType != null && _baithakType == Statics.abPratinidhiSabhaa)
                          Column(
                            children: <Widget>[
                              ...
                              SingleColumnRow(
                                  txtString: Statics.getLabel('vastiCountWithPastShaakhaa'),
                                  value: _ekatritVrutta['VastiCountWithPastShaakhaa'].toString(),
                                  fontsize: 15),
                              SingleColumnRow(
                                  txtString: Statics.getLabel('vastiCountWithPastSaaptaahik'),
                                  value: _ekatritVrutta['VastiCountWithPastSaaptaahik'].toString(),
                                  fontsize: 15),
                              SingleColumnRow(
                                  txtString: Statics.getLabel('graamCountWithPastShaakhaa'),
                                  value: _ekatritVrutta['GraamCountWithPastShaakhaa'].toString(),
                                  fontsize: 15),
                              SingleColumnRow(
                                  txtString: Statics.getLabel('graamCountWithPastSaaptaahik'),
                                  value: _ekatritVrutta['GraamCountWithPastSaaptaahik'].toString(),
                                  fontsize: 15),
                            ],
                          ),
...
// =============================================================Shakha Toli Baithak Kranare Saptahik Milananchi Sankhya===================================================================================================================
                        ...
                        SingleColumnRow(txtString: 'एकूण', value: _ekatritVrutta['TotalProudhBaithakSaaptaahikMilanToliCount'].toString(), fontsize: 15),
                        SizedBox(height: 20,),
...
// ================================================ palak yuktya SHakha Toli  ================================================
                        ...
                        SingleColumnRow(txtString: 'एकूण', value: _ekatritVrutta['shakhapalakTotalShaakhaaToliYuktaCount'].toString(), fontsize: 15),
                        SizedBox(height: 20,),
...
// ===================================== palak yuktya SAptahik MIlan Toli  =======================================================
                        ...
                        SingleColumnRow(txtString: Statics.getLabel('mahaavidyaalayeen'),value: _ekatritVrutta['issankalpitshakhapalakTarunVidyaarthiShaakhaaToliYuktaCount'].toString(),fontsize: 15),
                        SingleColumnRow(txtString: Statics.getLabel('vyavasaayeeTarun'),value: _ekatritVrutta['issankalpitshakhapalakTarunVyavasaayeeShaakhaaToliYuktaCount'].toString(),fontsize: 15),
                        ...
                        SingleColumnRow(txtString: 'एकूण', value: _ekatritVrutta['issankalpitshakhapalakTotalShaakhaaToliYuktaCount'].toString(), fontsize: 15),
                        SizedBox(height: 20,),
...
// ================================================  Varshik utsav  ================================================
                        ...
                        SingleColumnRow(txtString: 'एकूण', value: _ekatritVrutta['varshikmahotsavTotalShaakhaaToliYuktaCount'].toString(), fontsize: 15),
                        SizedBox(height: 20,),
...
// ===================================== Varshik utsav SAptahik MIlan Toli  =======================================================
                        ...
                        SingleColumnRow(txtString: Statics.getLabel('mahaavidyaalayeen'),value: _ekatritVrutta['varshikmahotsavsankalpitTarunVidyaarthiShaakhaaToliYuktaCount'].toString(),fontsize: 15),
                        SingleColumnRow(txtString: Statics.getLabel('vyavasaayeeTarun'),value: _ekatritVrutta['varshikmahotsavsankalpitTarunVyavasaayeeShaakhaaToliYuktaCount'].toString(),fontsize: 15),
                        ...
                        SingleColumnRow(txtString: 'एकूण', value: _ekatritVrutta['varshikmahotsavsankalpitTotalShaakhaaToliYuktaCount'].toString(), fontsize: 15),
                        SizedBox(height: 20,),
...
// =====================================  bal vayogat gela mahina   ==============================================================================================================
                        ...
                        SingleColumnRow(txtString: Statics.getLabel('Shaakhaa') + ':-', value: '', fontsize: 18),
                        SingleColumnRow(txtString: Statics.getLabel('ShaakhaaEQ0'), value: "${_ekatritVrutta['balShaakhaaEQ0'] +_ekatritVrutta['MahavidyaShaakhaaEQ0'] +_ekatritVrutta['TarunShaakhaaEQ0'] +_ekatritVrutta['ProudhShaakhaaEQ0'] }", fontsize: 15),
                        SingleColumnRow(txtString: Statics.getLabel('Shaakhaa1To24'), value: "${_ekatritVrutta['balShaakhaa1To24'] +_ekatritVrutta['MahavidyaShaakhaa1To24'] +_ekatritVrutta['TarunShaakhaa1To24'] + _ekatritVrutta['ProudhShaakhaa1To24']}", fontsize: 15),
                        SingleColumnRow(txtString: Statics.getLabel('ShaakhaaGTE25'), value: "${_ekatritVrutta['balShaakhaaGTE25'] +_ekatritVrutta['MahavidyaShaakhaaGTE25'] +_ekatritVrutta['TarunShaakhaaGTE25'] + _ekatritVrutta['ProudhShaakhaaGTE25']}", fontsize: 15),
                        SingleColumnRow(txtString: Statics.getLabel('ShaakhaaEQ30'), value: "${_ekatritVrutta['balShaakhaaEQ30'] +_ekatritVrutta['MahavidyaShaakhaaEQ30'] +_ekatritVrutta['TarunShaakhaaEQ30'] + _ekatritVrutta['ProudhShaakhaaEQ30']}", fontsize: 15),
                        SingleColumnRow(txtString: Statics.getLabel('SaaptaahikMilan') + ':-', value: '', fontsize: 18),
                        SingleColumnRow(txtString: Statics.getLabel('SaaptaahikEQ0'), value: "${_ekatritVrutta['balSaaptaahikEQ0'] +_ekatritVrutta['MahavidyataahikEQ0'] +_ekatritVrutta['TarunSaaptaahikEQ0'] + _ekatritVrutta['ProudhSaaptaahikEQ0']}", fontsize: 15),
                        SingleColumnRow(txtString: Statics.getLabel('Saaptaahik1To3'), value:  "${_ekatritVrutta['balSaaptaahik1To3'] +_ekatritVrutta['MahavidyaSaaptaahik1To3'] +_ekatritVrutta['TarunSaaptaahik1To3'] + _ekatritVrutta['ProudhSaaptaahik1To3']}", fontsize: 15),
                        SingleColumnRow(txtString: Statics.getLabel('SaaptaahikGTE4'), value: "${_ekatritVrutta['balSaaptaahikGTE4'] +_ekatritVrutta['MahavidyaSaaptaahikGTE4'] +_ekatritVrutta['TarunSaaptaahikGTE4'] + _ekatritVrutta['ProudhSaaptaahikGTE4']}", fontsize: 15),
                        SingleColumnRow(txtString: Statics.getLabel('MaasikMilan') + '/' + Statics.getLabel('SanghaMandali') + ':-',value: '',fontsize: 18),
                        SingleColumnRow(txtString: Statics.getLabel('MaasikEQ0'), value:  "${_ekatritVrutta['balMaasikEQ0'] +_ekatritVrutta['MahavidyaMaasikEQ0'] +_ekatritVrutta['TarunMaasikEQ0'] + _ekatritVrutta['ProudhMaasikEQ0']}", fontsize: 15),
                        SingleColumnRow(txtString: Statics.getLabel('MaasikEQ1'), value: "${_ekatritVrutta['balMaasikEQ1'] +_ekatritVrutta['MahavidyaMaasikEQ1'] +_ekatritVrutta['TarunMaasikEQ1'] + _ekatritVrutta['ProudhMaasikEQ1']}", fontsize: 15),
                        SizedBox(height: 15,),
