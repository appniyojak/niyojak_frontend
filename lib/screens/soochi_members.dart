...
class _SoochiMembersState extends State<SoochiMembers> {
  ...
  Future<List<dynamic>> _getMembersList() async {
    ...
    if (isConnected) {
      ...
      print("soochiIdsoochiId ==> $soochiId");
      return Statics.getSoochiMembers(soochiId);
    } else {
      setState(() {
        _isfetingData = false;
      });
  ...
  void _getCsv() async {
    ...
    List<dynamic> dataList = await _getMembersList();
            ...
            child: Container(
              ...
              child: Form(
                ...
                child: Column(children: <Widget>[
                  ...
                  Legend(legendString: 'SoochiMembers', fontsize: 18),
                  CheckboxListTile(
