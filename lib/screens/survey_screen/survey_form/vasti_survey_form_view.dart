...
class _VastiSurveyFormScreenState extends State<VastiSurveyFormScreen> with SingleTickerProviderStateMixin {
  ...
  void setDataAfterSearch() async {
        setState(() {
          ...
          vastiSamitiYesNo = int.parse(vastiDataByIdModel!.vastisarvekshan!.vastiShakhaSamiti == null ||vastiDataByIdModel!.vastisarvekshan!.vastiShakhaSamiti! == "null" || vastiDataByIdModel!.vastisarvekshan!.vastiShakhaSamiti == "" ? "2":vastiDataByIdModel!.vastisarvekshan!.vastiShakhaSamiti!);
...
// ==================   DROP - DOWNS ====================================================================================================================================
  ...
  void initState() {
    ...
    if(
    (int.parse(Statics.userDetails['LevelID'])  <= 2 )
    ){
      setState(() {
        isVastiSearch = true;
        _isExpanded = false;
  ...
  void _handleTabSelection() {
    if (_tabController.index == 1 && !_isStep1Completed!) {
      ...
      if (!_isStep1Completed!) {
        showPopupForNaviagtetoOtherPage(context, "प्राथमिक माहिती", "विस्तृत माहिती");
        _tabController.index = 0;
      } else if (!_isStep2Completed!) {
        showPopupForNaviagtetoOtherPage(context, "अन्य माहिती", "विस्तृत माहिती");
                      ...
                      return Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Expanded(
                              child:imageAdd == 1
                                      ? Image.file(File(filePathOg!),fit: BoxFit.contain,)
                                   : Image.network('${Statics.baseUrl}/Files/Vastisarvekshanforms/$selectedFileName',fit: BoxFit.contain,),
                            ),
                          ],
                        ),
                      );
  ...
  //                                 Navigator.of(context).pop();
  //                               },
  //                               icon: Icon(Icons.close, color: Colors.purpleAccent),
  //                             ),
  //                           ),
  //                           SizedBox(height: 10),
  //                           Expanded(
  ...
  //                 String base64File = "data:image/jpg;base64,$base64String";
  //
  //                 log("Base64 Conversion Successful. Length: ${base64File.length}");
  //                 onFileSelected(base64File, fileName);
  //               }
  //             } catch (e) {
  //               log("Error during file processing: $e");
  ...
  //              //
  //              // log("base64Filebase64File-->> $base64File");
  //              //  onFileSelected(base64File, fileName);
  //               try {
  //                 File file = File(filePath);
  //                 List<int> fileBytes = await file.readAsBytes();
  //                 String base64String = base64Encode(fileBytes);
  //                 String base64File = "data:image/$fileExtension;base64,$base64String";
  //
  //                 log("Base64 String Length: ${base64File.length}");
  //                 log("Base64 Conversion Successful");
  //                 onFileSelected(base64File, fileName);
  //               } catch (e) {
  //                 log("Error during base64 conversion: $e");
  //               }
  //
  //             }
  //           } else {
    ...
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<T>(
          iconEnabledColor: iconColor ?? Colors.white, // Customizable icon color
          hint: Text(
  ...
  Widget _buildStep1() {
    ...
    return SingleChildScrollView(
      ...
      if((int.parse(Statics.userDetails['LevelID']) > 5))
          ...
          if(isVastiSearch == false)
            Column(
              ...
              children: [
                Text(
                  "टीप :- माहिती भरण्यापूर्वी वस्ती निवडणे अनिवार्य आहे.",
                  style: TextStyle(
                    color: Colors.red,
                    fontWeight: FontWeight.bold,
                  ),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    //   name: 'वस्ती प्रमुखाचे नाव',
                    //   controller: sanghaKaryaVastiPramukhNameController,
                    //   height: 50,
                    //   keyboardType: TextInputType.text,
                    //   isEdit: true
                    // ),
                    Align(alignment: Alignment.centerLeft,child: Text("वस्ती प्रमुखाचे नाव",style:TextStyle(fontWeight: FontWeight.bold,color: Colors.black,fontSize: 15))),
                    Align(alignment: Alignment.centerLeft,child: Text("- ${sanghaKaryaVastiPramukhNameController.text}",style:TextStyle(fontWeight: FontWeight.bold,color:sanghaKaryaVastiPramukhNameController.text == "नियुक्त नाही" ? Colors.red: Colors.purple))),
                    SizedBox(height: 10),
                    textControllerField2(
                      name: 'लोकसंख्या',
                    ...
                    SizedBox(height: 10),
                    yesNoRadioButton(
                      question: "वस्ती समिती आहे ?",
                      selectedOption: vastiSamitiYesNo ?? 2,
                      onChanged: (value) {
                        if (isVastiSearch) {
                          setState(() {vastiSamitiYesNo = value;});
                        } else {
                          showPopupForVastiValidation(context,);
                        }
                      },
      ...
      // ===================================== Bhougolik STITHI  STITHI ==================================================================================
          mainContainer("भौगोलिक स्थिति",   Column(
            children: [
              textControllerField('वस्तीच्या चतु:सीमा',vastiChatahuSimaController,context,height: 100),
              filePickerField(
                question: "वस्तीचा गूगल मॅप (सीमा अक्षांश /रेखांश सह )",
      ...
      // ===================================== JAGRAN SHRENI STITHI ==================================================================================
          mainContainer("जागरण श्रेणी स्थिति",   Column(
            children: [
              Row(
                mainAxisAlignment: MainAxisAlignment.end,
                children: [
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                              ...
                              return AlertDialog(
                                ...
                                content: Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: 12),
                                    _buildInfoRow("नियमित\nचालणारे उपक्रम", selectedData.niyamitacalanareupakrama),
                                    SizedBox(height: 12),
                                    _buildInfoRow("वारंवारिता", selectedData.selectedDropdownValueName1),
                                    SizedBox(height: 12),
                                    _buildInfoRow("अन्य वारंवारिता", selectedData.otherVaranvarita),
                                  ],
                                ),
                                actionsAlignment: MainAxisAlignment.center,
                                actions: [
                    ...
                    InkWell(
                      onTap: () {
                        showJagranShreniPopup(context, onDataChanged: () {setState(() {});},editIndex:selectedJagranShreniStithiRowIndex );
      ...
      // ===================================== GATIVIDHI KAARYA STITHI ==================================================================================
          mainContainer("गतिविधी कार्य स्थिति",   Column(
            children: [
              Row(
                mainAxisAlignment: MainAxisAlignment.end,
                children: [
                  InkWell(
                    onTap: () {
                      ...
                      if (isVastiSearch) {
                        showGatividhiPopup(context, onDataChanged: () {setState(() {});});
                      } else {
                        showPopupForVastiValidation(context,);
                      }
                  ...
                  child: ConstrainedBox(
                    ...
                    child: DataTable(
                      ...
                      columns: const [
                        ...
                        DataColumn(label: Text("नियमित चालणारे उपक्रम",)),
                        DataColumn(label: Text("वारंवारिता",)),
                      ],
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                              ...
                              return AlertDialog(
                                ...
                                content: Column(
                                  ...
                                  children: [
                                    Divider(thickness: 1, color: Colors.purpleAccent.shade100),
                                    SizedBox(height: 12),
                                    _buildInfoRow("गतिविधी", selectedData.selectedDropdownValueName),
                                    SizedBox(height: 12),
                                    _buildInfoRow("नियमित\nचालणारे उपक्रम", selectedData.niyamitacalanareupakrama),
                                    SizedBox(height: 12),
                                    _buildInfoRow("वारंवारिता", selectedData.selectedDropdownValueName1),
                    ...
                    InkWell(
                      onTap: () {
                        showGatividhiPopup(context, onDataChanged: () {setState(() {});},editIndex:selectedGatividhiKaryaStithiRowIndex );   },
                      child: Icon(Icons.edit, color: Colors.blue, size: 20),
                    ),
                    SizedBox(width: 20,),
                    InkWell(
                      onTap: () async {
                        ...
                        if (shouldDelete == true && selectedGatividhiKaryaStithiRowIndex != null) {
                          // setState(() {
                          //   enteredDataListGatividhi!
                          //       .removeAt(selectedGatividhiKaryaStithiRowIndex!);
      ...
      // ===================================== VASIHAT PRAKAR ==================================================================================
          mainContainer("वसाहत प्रकार",Column(
                      children: [
                        Row(
                          mainAxisAlignment: MainAxisAlignment.end,
                          children: [
                            InkWell(
                              onTap: (){
                                ...
                                if (isVastiSearch) {
                                  showVsahatTypePopup(context, onDataChanged: () {setState(() {});});
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                                        ...
                                        return AlertDialog(
                                          ...
                                          content: Column(
                                            ...
                                            children: [
                                              ...
                                              SizedBox(height: 12),
                                              _buildInfoRow("भवनाचे नाव", selectedData.bhavanachenav),
                                              SizedBox(height: 12),
                                              _buildInfoRow("संपर्क स्थिति", selectedData.selectedDropdownValueName1),
                                              SizedBox(height: 12),
                                              _buildInfoRow("संपर्क सूत्र", selectedData.samparksootr),
                                              SizedBox(height: 12),
                                              _buildInfoRow("संपर्क सूत्रांचे दूरभाष", selectedData.doorabhaash),
                                            ],
                                          ),
                                          actionsAlignment: MainAxisAlignment.center,
                                          actions: [
                              ...
                              InkWell(
                                onTap: () {
                                  showVsahatTypePopup(context, onDataChanged: () {setState(() {});},editIndex:selectedvsahatPrakarIdRowIndex );   },
                                child:Icon(Icons.edit, color: Colors.blue, size: 20),
                              ),
                              SizedBox(width: 20,),
                              InkWell(
                                onTap: () async {
                                  ...
                                  if (shouldDelete == true && selectedvsahatPrakarIdRowIndex != null) {
                                    // setState(() {
                                    //   enteredVasahatPrakarDataList
                                    //       .removeAt(selectedvsahatPrakarIdRowIndex!);
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      InkWell(
                                        onTap: (){
                                          if (isVastiSearch) {
                                            showVividhBhashaBolnarePopup(context, onDataChanged: () {setState(() {});},);
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                                  ...
                                                  return AlertDialog(
                                                    ...
                                                    content: Column(
                                                      ...
                                                      children: [
                                                        Divider(thickness: 1, color: Colors.purpleAccent.shade100),
                                                        SizedBox(height: 12),
                                                        _buildInfoRow("भाषा", selectedData.selectedDropdownValueName),
                                                        SizedBox(height: 12),
                                                        _buildInfoRow("अन्य भाषा", selectedData.otherbhaasha),
                                                        SizedBox(height: 12),
                                        ...
                                        InkWell(
                                          onTap: () {
                                            showVividhBhashaBolnarePopup(context,editIndex:selectedVividhBhashaBolnarerIdRowIndex, onDataChanged: () {setState(() {});} );   },
                                          child:Icon(Icons.edit, color: Colors.blue, size: 20),
                                        ),
                                        SizedBox(width: 20,),
                                        InkWell(
                                          onTap: () async {
                                            ...
                                            if (shouldDelete == true && selectedVividhBhashaBolnarerIdRowIndex != null) {
                                              // setState(() {
                                              //   enteredVividhBhashaBolnareDataList
                                              //       .removeAt(selectedVividhBhashaBolnarerIdRowIndex!);
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      InkWell(
                                        onTap: (){
                                          if (isVastiSearch) {
                                            showKontyaPraantachePopup(context, onDataChanged: () {setState(() {});},);
                                          } else {
                                            showPopupForVastiValidation(context);
                                          }
                                        },
                                    ...
                                    child: SingleChildScrollView(
                                      ...
                                      child: SizedBox(
                                        ...
                                        child: DataTable(
                                          ...
                                          rows: enteredKontyaPraantacheDataList.asMap()
                                              .entries
                                              .where((entry) => entry.value.isactive == 1)
                                              .map((entry) {
                                            int index = entry.key;
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                                  ...
                                                  return AlertDialog(
                                                    ...
                                                    content: Column(
                                                      ...
                                                      children: [
                                                        Divider(thickness: 1, color: Colors.purpleAccent.shade100),
                                                        SizedBox(height: 12),
                                                        _buildInfoRow("प्रांत", selectedData.selectedDropdownValueName),
                                                        SizedBox(height: 12),
                                                        _buildInfoRow("अन्य प्रांत", selectedData.anyaPraantName),
                                                        SizedBox(height: 12),
                                                        _buildInfoRow("अंदाजे लोकसंख्या", selectedData.andaje),
                                                      ],
                                                    ),
                                                    actionsAlignment: MainAxisAlignment.center,
                                                    actions: [
                                        ...
                                        InkWell(
                                          onTap: () {
                                            showKontyaPraantachePopup(context,editIndex:selectedKontyaPraantacheIdRowIndex, onDataChanged: () {setState(() {});} );   },
                                          child: Icon(Icons.edit, color: Colors.blue, size: 20),
                                        ),
                                        SizedBox(width: 20,),
                                        InkWell(
                                          onTap: () async {
                                            ...
                                            if (shouldDelete == true && selectedKontyaPraantacheIdRowIndex != null) {
                                              // setState(() {
                                              //   enteredKontyaPraantacheDataList
                                              //       .removeAt(selectedKontyaPraantacheIdRowIndex!);
    ...
    children: [
      ...
      //=================================================== VASTIT SAJAR HONARE SAN FORM ====================================================================================
                          ...
                          Row(
                            ...
                            children: [
                              Text(
                                "वस्तीत साजरे होणारे महत्त्वाचे सण",
                                style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold,color: Colors.purpleAccent),
      ...
      //=================================================== VASTIT SAJAR HONARE samajik karyakyram FORM ====================================================================================
                          ...
                          Row(
                            ...
                            children: [
                              Flexible(
                                child: Text(
                                  "वस्तीत साजरे होणारे महत्वाचे सामाजिक कार्यक्रम",
                                  style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold,color: Colors.purpleAccent),
                                  softWrap: true,
                                      ...
                                      showDialog(
                                        ...
                                        builder: (context) {
                                          return AlertDialog(
                                            ...
                                            title: Center(
                                              child: Text(
                                                "वस्तीत होणारे सामाजिक कार्यक्रम",
                                                style: TextStyle(
                                                  fontWeight: FontWeight.bold,
                                                  fontSize: 20,
                                                  color: Colors.purpleAccent,
                                ...
                                showDialog(
                                  ...
                                  builder: (context) => AlertDialog(
                                    ...
                                    content: Padding(
                                      padding: const EdgeInsets.symmetric(vertical: 10),
                                      child: Text(
                                        "वस्ती समिती आणि लोकसंख्या आवश्यक.",
                                        style: TextStyle(
                                          fontSize: 16,
                                          color: Colors.red.shade800,
                                        ),
                          ...
                          children: [
                            ...
                            vastisarvekshanDropDownDataModel != null
                              ...
                              onItemSelected: (id, value,isOther) {
                                ...
                                print("selectedVaramvaritaID $selectedVaramvaritaID |||| selectedVaramvaritaName $selectedVaramvaritaName");
                            ...
                            if(selectedVaramvarita?.isOther == 1)
                              textControllerField2(name: "अन्य",controller: isOtherJaganVaramvaritaConroller),
...
//========================  3. GATIVIDHI FORM ===========================================
  ...
  void showGatividhiPopup(BuildContext context, {int? editIndex, VoidCallback? onDataChanged}) {
    ...
    if (editIndex != null) {
      ...
      selectedVaramvaritaGatividhi = vastisarvekshanDropDownDataModel!.masterdata!
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text("गतिविधी कार्य स्थिति", style: TextStyle(fontSize: 20, color: Colors.purpleAccent, fontWeight: FontWeight.bold)),
                          IconButton(
                            icon: Icon(Icons.close, color: Colors.grey[700]),
                            onPressed: () {
                              clearFields3();
                      ...
                      vastisarvekshanDropDownDataModel != null
                        ...
                        hintText: "गतिविधी निवडा",
                        question: "गतिविधी निवडा",
                        ...
                        onSelectionChanged: (newValue) {
                          ...
                          : Container(),
                      SizedBox(height: 10),
                      textControllerField('नियमित चालणारे उपक्रम', niyamitChalnareUpkramGatividhiController, context, height: 100),
                      SizedBox(height: 10),
                      vastisarvekshanDropDownDataModel != null
                          ? vastisarvekshanDropdown2(
                        dataModel: vastisarvekshanDropDownDataModel!,
                      ...
                      if (selectedVaramvaritaGatividhi?.isOther == 1)
                        textControllerField2(name: "अन्य", controller: anyaGatividhiVaramvaritaController, hintTextString: "अन्य वारंवारिता"),
                      SizedBox(height: 20),
                      Align(
                        alignment: Alignment.center,
                        child: ElevatedButton(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 10),
                      textControllerField2(controller:vsahatPrakarBhavnacheNavController,name:"भवनाचे नाव", keyboardType: TextInputType.text,height: 50 ),
                      const SizedBox(height: 10),
                      // Dropdown 1
                      Align(
                      ...
                      const SizedBox(height: 10),
                      textControllerField2(controller:vsahatPrakarSamparkKshetraController,name:"संपर्क सूत्र", keyboardType: TextInputType.text,height: 50 ),
                      const SizedBox(height: 10),
                      textControllerField2(controller:vsahatPrakarDurbhashController,name:"संपर्क सूत्रांचे दूरभाष", keyboardType: TextInputType.number,maxInput: 10,),
...
//                               "prakarName": vsahatPrakarName,
//                               "prakarId": vsahatPrakarId,
//                               "bhavnacheNav": vsahatPrakarBhavnacheNavController.text.trim(),
//                               "samparkStatus": vsahatSamparkName,
//                               "samparkId": vsahatSamparkId,
//                               "samparkKshetra": vsahatPrakarSamparkKshetraController.text.trim(),
//                               "durbhash": vsahatPrakarDurbhashController.text.trim(),
// //========================================= REQUEST ====================================================================
//                               "pkid": 0,
//                               "vastiid": int.parse(selctedLevelId!),
//                               "prakarid": vsahatPrakarId,
//                               "bhavanachenav": vsahatPrakarBhavnacheNavController.text.trim(),
//                               "samparksthitiid": vsahatSamparkId,
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      textControllerField2(controller:anyaBhashaNameController,name:"अन्य भाषा",height: 50,hintTextString: "भाषा"),
                      SizedBox(height: 10),
                      textControllerField2(controller:bhashaPersentCount,name:"अंदाजे (%)", keyboardType: TextInputType.number,height: 50,hintTextString: "उदा. ० ते १०० "),
                      SizedBox(height: 10),
                      Align(
                        alignment: Alignment.center,
                        child: ElevatedButton(
                    ...
                    children: [
                      ...
                      Statics.showToast("'अन्य' माहिती आवश्यक.");
                            ...
                            final item = VastisarKonatyaprantache(
                              ...
                              andaje: loksankhyaAveragePersentCount.text.trim(),
              ...
              return SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    textControllerField2(name: "पत्ता",controller:  anyaPrabhaviLokAddressController,  height: 50),
                    ...
                    SizedBox(height: 10,),
                    textControllerField2(name: "अन्य विशेष माहिती",controller: anyaPrabhaviLokAnyaVisheshMahitiController,height: 50),
                    vastisarvekshanDropDownDataModel != null ?
                    vastisarvekshanDropdown2(
                      hintText: "संपर्क स्थिति निवडा",
                    ...
                    textControllerField2(name: "संपर्क सूत्रांचे दूरभाष",controller:  anyaPrabhaviLokSamparkSutraDoorbhashController,keyboardType: TextInputType.number,maxInput: 10,),
                  ],
                ),
              );
            },
              ...
              return SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    textControllerField("अन्य सण", vastitSajarHonareAnyaSanController, context, height: 50),
                    textControllerField("आयोजक संस्थाची नावे", vastitSajarHonareSanAyojakSansthaNameController, context, height: 50),
                    textControllerField("आयोजकांची नावे", vastitSajarHonareSanAyojakNameController, context, height: 80),
                    textControllerField("आयोजक संपर्क सूत्र", vastitSajarHonareSanAyojakSamparkController, context, height: 50),
                    const SizedBox(height: 10),
                  ],
                ),
              );
...
//======================== VASTITIL BALOSAPANA KENDRA  =======================================================
            mainContainer("वस्तीतील बलोपासना केंद्र",
                Column(
                  children: [
                    Align(
                      ...
                      child: InkWell(
                        onTap: () {
                          if (isVastiSearch) {
                            showVastitBalopasanaKendraPopup(context, onDataChanged: () {setState(() {});},);
                          } else {
                            showPopupForVastiValidation(context);
                          }
                        },
                      ...
                      child: SingleChildScrollView(
                          ...
                          child: SizedBox(
                            ...
                            child: DataTable(
                              ...
                              headingTextStyle: TextStyle(fontWeight: FontWeight.bold,color: Colors.black87),
                              columns: const [
                                DataColumn(label: Text("बलोपासना केंद्र",)),
                                DataColumn(label: Text("नाव",)),
                                DataColumn(label: Text("कोणासाठी",)),
                              ],
                              rows: vastitBalopasanaKendraDataList.asMap()
                                              .entries
                                              .where((entry) => entry.value.isactive == 1)
                                              .map((entry) {
                                int index = entry.key;
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                                      ...
                                      content: SingleChildScrollView(
                                        child: Column(
                                          ...
                                          children: [
                                            Divider(thickness: 1, color: Colors.deepPurple.shade100),
                                            SizedBox(height: 12),
                                            _buildInfoRow("बलोपासना केंद्र", selectedData.selectedDropdownValueName),
                                            _buildInfoRow("अन्य बलोपासना केंद्र", selectedData.otherBalopasanaShreniName),
                                            _buildInfoRow("नाव", selectedData.name),
                                            _buildInfoRow("कोणासाठी", selectedData.konasathi),
                                          ],
                                        ),
                                      ),
                                      actionsAlignment: MainAxisAlignment.center,
                          ...
                          SizedBox(width: 20,),
                          InkWell(
                            onTap: () {showVastitBalopasanaKendraPopup(context, editIndex: selectedVastitBalopasanaKendraIdIndex, onDataChanged: () { setState(() {});});},
                            child:Icon(Icons.edit, color: Colors.blue, size: 20),
                          ),
                          SizedBox(width: 20,),
                          InkWell(
                            onTap: () async {
                              ...
                              if (shouldDelete == true && selectedVastitBalopasanaKendraIdIndex != null) {
                                // setState(() {
                                //   vastitBalopasanaKendraDataList
                                //       .removeAt(selectedVastitBalopasanaKendraIdIndex!);
                    ...
                    // SizedBox(height: 5),
                    // textControllerField( "बलोपासना केंद्र (अन्य)", vastitBalopasanaKendraAnyaController,context,height: 80,),
                  ],
                )),
//======================== VASTITIL BALOSAPANA KENDRA  =======================================================
            mainContainer("मोठे व्यावसायिक केंद्र",Column(
                  children: [
                    Align(
                      alignment: Alignment.centerRight,
                      child: InkWell(
                        onTap: () {
                          if (isVastiSearch) {
                            showMotheVyavsayikKendraPopup(context ,onDataChanged: () { setState(() {});});
                          } else {
                            showPopupForVastiValidation(context);
                          }
                          },
                      ...
                      child: SingleChildScrollView(
                          ...
                          child: SizedBox(
                            ...
                            child: DataTable(
                              ...
                              headingTextStyle: TextStyle(fontWeight: FontWeight.bold,color: Colors.black87),
                              columns: const [
                                DataColumn(label: Text("मोठे व्यवसायिक केंद्र",)),
                                DataColumn(label: Text("नाव",)),
                              ],
                              rows: motheVyasayikKendraDataList.asMap()
                                              .entries
                                              .where((entry) => entry.value.isactive == 1)
                                              .map((entry) {
                                int index = entry.key;
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                                      ...
                                      content: SingleChildScrollView(
                                        child: Column(
                                          ...
                                          children: [
                                            Divider(thickness: 1, color: Colors.deepPurple.shade100),
                                            SizedBox(height: 12),
                                            _buildInfoRow("मोठे व्यवसायिक केंद्र", selectedData.selectedDropdownValueName),
                                            _buildInfoRow("नाव", selectedData.name),
                                          ],
                                        ),
                                      ),
                          ...
                          InkWell(
                            onTap: () {
                              showMotheVyavsayikKendraPopup(context, editIndex: selectedMotheVyasayikKendraIdIndex, onDataChanged: () { setState(() {});});},
                            child:Icon(Icons.edit, color: Colors.blue, size: 20),
                          ),
                          SizedBox(width: 20,),
                          InkWell(
                            onTap: () async {
                              ...
                              if (shouldDelete == true && selectedMotheVyasayikKendraIdIndex != null) {
                                // setState(() {
                                //   motheVyasayikKendraDataList
                                //       .removeAt(selectedMotheVyasayikKendraIdIndex!);
...
//======================== NIRMANDHIN MOTHE PRAKALPA KENDRA  =======================================================
            mainContainer("निर्माणाधीन मोठे प्रकल्प",Column(
                  children: [
                    Align(
                      alignment: Alignment.centerRight,
                      child: InkWell(
                        onTap: () {
                          if (isVastiSearch) {
                            showNirmaandhinMothePopup(context,onDataChanged: () { setState(() {});});
                          } else {
                            showPopupForVastiValidation(context);
                          }
                        },
                      ...
                      child: SingleChildScrollView(
                          ...
                          child: SizedBox(
                            ...
                            child: DataTable(
                              ...
                              columns: const [
                                DataColumn(label: Text("नाव",)),
                                DataColumn(label: Text("प्रकल्प",)),
                              ],
                              rows: nirmandhinMothePrakalpaDataList.asMap()
                                              .entries
                                              .where((entry) => entry.value.isactive == 1)
                                              .map((entry) {
                                int index = entry.key;
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                                      ...
                                      content: SingleChildScrollView(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            SizedBox(height: 12),
                                            _buildInfoRow("नाव", selectedData.name),
                                            _buildInfoRow("प्रकल्प", selectedData.selectedDropdownValueName),
                                          ],
                                        ),
                                      ),
                                      actionsAlignment: MainAxisAlignment.center,
                          ...
                          SizedBox(width: 20,),
                          InkWell(
                            onTap: () {showNirmaandhinMothePopup(context, editIndex: selectednirmandhinMothePrakalpaIdIndex, onDataChanged: () { setState(() {});});},
                            child:Icon(Icons.edit, color: Colors.blue, size: 20),
                          ),
                          SizedBox(width: 20,),
                          InkWell(
                            onTap: () async {
                              ...
                              if (shouldDelete == true && selectednirmandhinMothePrakalpaIdIndex != null) {
                                // setState(() {
                                //   nirmandhinMothePrakalpaDataList
                                //       .removeAt(selectednirmandhinMothePrakalpaIdIndex!);
...
//======================== MOTHE RUGNALAY KENDRA  =======================================================
            mainContainer("मोठे रुग्णालय",Column(
                  children: [
                    Align(
                      alignment: Alignment.centerRight,
                      child: InkWell(
                        onTap: () {
                          if (isVastiSearch) {
                            showMotheRugnalayPopup(context,onDataChanged: () { setState(() {});});
                          } else {
                            showPopupForVastiValidation(context);
                          }
                        },
                      ...
                      child: SingleChildScrollView(
                          ...
                          child: SizedBox(
                            ...
                            child: DataTable(
                              ...
                              headingTextStyle: TextStyle(fontWeight: FontWeight.bold,color: Colors.black87),
                              columns: const [
                                DataColumn(label: Text("रुग्णालय",)),
                                DataColumn(label: Text("नाव",)),
                              ],
                              rows: motheRugnalayDataList.asMap()
                                              .entries
                                              .where((entry) => entry.value.isactive == 1)
                                              .map((entry) {
                                int index = entry.key;
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                                      ...
                                      content: SingleChildScrollView(
                                        child: Column(
                                          ...
                                          children: [
                                            Divider(thickness: 1, color: Colors.deepPurple.shade100),
                                            SizedBox(height: 12),
                                            _buildInfoRow("रुग्णालय", selectedData.selectedDropdownValueName),
                                            _buildInfoRow("नाव", selectedData.name),
                                          ],
                                        ),
                                      ),
                          ...
                          SizedBox(width: 20,),
                          InkWell(
                            onTap: () {showMotheRugnalayPopup(context, editIndex: selectedmotheRugnalayIdIndex, onDataChanged: () { setState(() {});});},
                            child:Icon(Icons.edit, color: Colors.blue, size: 20),
                          ),
                          SizedBox(width: 20,),
                          InkWell(
                            onTap: () async {
                              ...
                              if (shouldDelete == true && selectedmotheRugnalayIdIndex != null) {
                                // setState(() {
                                //   motheRugnalayDataList
                                //       .removeAt(selectedmotheRugnalayIdIndex!);
...
//===================================================================================================================================================================================
            mainContainer("अग्निशमन दल केंद्र",Column(
                  children: [
                    yesNoRadioButton(question: "अग्निशमन दल केंद्र आहे?", onChanged: (value) {
                      if (isVastiSearch) {
                        setState(() {agniShamanDalKendraAhe = value;});
                      } else {
                        showPopupForVastiValidation(context,);
                      }
...
//===================================================================================================================================================================================
            mainContainer("पोलीस ठाणे/चौकी",Column(
                  children: [
                    yesNoRadioButton(question: "पोलीस ठाणे/चौकी आहे?", onChanged: (value) {
                      if (isVastiSearch) {
                        setState(() {polichChoukiAhe = value;});
                      } else {
                        showPopupForVastiValidation(context,);
                      }
...
//==================================  SHAIKSHANIK SANSTHA FORM =================================================================================================================================================
            mainContainer("शैक्षणिक संस्था",Column(
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.end,
                      children: [
                        InkWell(
                          onTap: () {
                            if (isVastiSearch) {
                              showShaikshanikSansthaPopup(context,onDataChanged: () { setState(() {});},);
                            } else {
                              showPopupForVastiValidation(context);
                            }
                          },
                          ...
                          child: SingleChildScrollView(
                              ...
                              child: SizedBox(
                                ...
                                child: DataTable(
                                  ...
                                  headingTextStyle: TextStyle(fontWeight: FontWeight.bold,color: Colors.black87),
                                  columns: const [
                                    DataColumn(label: Text("शैक्षणिक संस्था प्रकार", )),
                                    DataColumn(label: Text("शैक्षणिक संस्था नाव", )),
                                  ],
                                  rows: allShaikshanikPrakarDataList.asMap()
                                              .entries
                                              .where((entry) => entry.value.isactive == 1)
                                              .map((entry) {
                                    int index = entry.key;
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                                          ...
                                          content: SingleChildScrollView(
                                            child: Column(
                                              ...
                                              children: [
                                                Divider(thickness: 1, color: Colors.deepPurple.shade100),
                                                SizedBox(height: 12),
                                                _buildInfoRow("शैक्षणिक संस्थान", selectedData.name),
                                                if(selectedData.shaikshaniksansthaan == 315)
                                                  _buildInfoRow("शाळा प्रकार", selectedData.selectedDropdownValueName),
                                                if(selectedData.shaikshaniksansthaan == 315)
                                                  _buildInfoRow("शिक्षणाचे\nमाध्यम", selectedData.selectedDropdownValueName1),
                                                if(selectedData.shaikshaniksansthaan == 315)
                                                  _buildInfoRow("संस्था चालक प्रकार", selectedData.selectedDropdownValueName2),
                                                if(selectedData.shaikshaniksansthaan == 316)
                                                  _buildInfoRow("महाविद्यालयीन\nप्रकार", selectedData.selectedDropdownValueName),
                                                _buildInfoRow("नाव", selectedData.name),
                                                _buildInfoRow("मिळकत", selectedData.selectedDropdownValueName4),
                                              ],
                                            ),
                                          ),
                                          actionsAlignment: MainAxisAlignment.center,
                              ...
                              InkWell(
                                onTap: () {
                                  showShaikshanikSansthaPopup(context, editIndex: selectedShaikshanikSansthaIdIndex, onDataChanged: () { setState(() {});},);},
                                child:Icon(Icons.edit, color: Colors.blue, size: 20),
                              ),
                              SizedBox(width: 20,),
                              InkWell(
                                onTap: () async {
                                  ...
                                  if (shouldDelete == true && selectedShaikshanikSansthaIdIndex != null) {
                                    // setState(() {
                                    //   allShaikshanikPrakarDataList
                                    //       .removeAt(selectedShaikshanikSansthaIdIndex!);
...
//================================== MAIDAAN UDYAAN FORM =================================================================================================================================================
            mainContainer("मैदान/उद्यान",Column(
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.end,
                      children: [
                        InkWell(
                          onTap: () {
                            ...
                            if (isVastiSearch) {
                              showMaidanUdyanPopup(context,onDataChanged: () { setState(() {});});
                            } else {
                              showPopupForVastiValidation(context);
                            }
                          },
                          ...
                          child: SingleChildScrollView(
                              ...
                              child: SizedBox(
                                ...
                                child: DataTable(
                                  ...
                                  rows: maidanUddyanDataList.asMap()
                                              .entries
                                              .where((entry) => entry.value.isactive == 1)
                                              .map((entry) {
                                    int index = entry.key;
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              SizedBox(width: 20,),
                              InkWell(
                                onTap: () {showMaidanUdyanPopup(context, editIndex: selectedMaidanUdyanIdIndex, onDataChanged: () { setState(() {});});},
                                child:Icon(Icons.edit, color: Colors.blue, size: 20),
                              ),
                              SizedBox(width: 20,),
                              InkWell(
                                onTap: () async {
                                  ...
                                  if (shouldDelete == true && selectedMaidanUdyanIdIndex != null) {
                                    // setState(() {
                                    //   maidanUddyanDataList
                                    //       .removeAt(selectedMaidanUdyanIdIndex!);
...
//================================== JAHIR KARYAKRAM SAMBANDHI FORM =================================================================================================================================================
            mainContainer("जाहीर कार्यक्रम संबंधी",Column(
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.end,
                      children: [
                        InkWell(
                          onTap: () {
                            ...
                            if (isVastiSearch) {
                              showjahirKaryakramPopup(context,onDataChanged: () { setState(() {});});
                            } else {
                              showPopupForVastiValidation(context);
                            }
                          },
                          ...
                          child: SingleChildScrollView(
                              ...
                              child: SizedBox(
                                ...
                                child: DataTable(
                                  ...
                                  rows: jahirKaryakramDataList.asMap()
                                              .entries
                                              .where((entry) => entry.value.isactive == 1)
                                              .map((entry) {
                                    int index = entry.key;
                                    ...
                                    return DataRow(
                                        ...
                                        cells: [
                                          ...
                                          DataCell(Text(data.nivasasathiupalabdha == 1 ?"होय":data.nivasasathiupalabdha == 0 ? "नाही":"-")),
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                                          ...
                                          content: SingleChildScrollView(
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                _buildInfoRow("प्रकार", selectedData.selectedDropdownValueName),
                                                _buildInfoRow("नाव", selectedData.name),
                                                _buildInfoRow("क्षमता", selectedData.shamta),
                                                _buildInfoRow("निवासासाठी उपलब्ध", selectedData.nivasasathiupalabdha == 1 ?"होय":selectedData.nivasasathiupalabdha == 0 ? "नाही":"-"),
                                                _buildInfoRow("निवास क्षमता", selectedData.nivaaskshamata),
                                              ],
                                            ),
                                          ),
                                          actionsAlignment: MainAxisAlignment.center,
                              ...
                              SizedBox(width: 20,),
                              InkWell(
                                onTap: () {showjahirKaryakramPopup(context, editIndex: selectedjahirKaryakramIdIndex, onDataChanged: () { setState(() {});});},
                                child:Icon(Icons.edit, color: Colors.blue, size: 20),
                              ),
                              SizedBox(width: 20,),
                              InkWell(
                                onTap: () async {
                                  ...
                                  if (shouldDelete == true && selectedjahirKaryakramIdIndex != null) {
                                    // setState(() {
                                    //   jahirKaryakramDataList
                                    //       .removeAt(selectedjahirKaryakramIdIndex!);
    ...
    showDialog(
      ...
      builder: (ctx) {
        return AlertDialog(
          ...
          content: StatefulBuilder(
        builder: (context, setState) {
        final Map<int, String> genderMap = {0: 'महिला',1: 'पुरुष',2: 'दोघांसाठी',};
        int? getGenderIndexFromLabel(String? label) {
        if (label == null) return null;
        return genderMap.entries
            .firstWhere((entry) => entry.value == label, orElse: () => const MapEntry(-1, ''))
            .key;
        }
        ...
        return SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    textControllerField("अन्य केंद्र", vastitBalopasanaKendraAnyaNameController, context, height: 50),
                    textControllerField("नाव", vastitBalopasanaKendraNaavController, context, height: 50),
                    const SizedBox(height: 10),
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(
                          "बलोपासना केंद्र कुणासाठी ?",
        ...
        Statics.showToast("'अन्य' माहिती आवश्यक.");
          ...
          VastisarVastitilabalopasanakendra data = VastisarVastitilabalopasanakendra(
              ...
              otherBalopasanaShreniName: vastitBalopasanaKendraAnyaNameController
                  .text
          );
          if (editIndex != null) {
              ...
              return SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 10),
                    textControllerField("नाव", motheVyasayikKendraNaavController, context, height: 50),
                    const SizedBox(height: 5),
                  ],
                ),
              );
          ...
          actions: [
            ...
            Align(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  // Map<String, dynamic> data = {
                  //   "motheVyasayikKendraID": selectedMotheVyasayikKendraId,
                  //   "motheVyasayikKendraName": selectedMotheVyasayikKendraName,
                  //   "motheVyasayikKendraNaav": motheVyasayikKendraNaavController.text,
                  //   "motheVyasayikObj": selectedMasterMotheVyasayikKendraName,
                  // };
            ...
            builder: (context, setState) {
              return SingleChildScrollView(
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    textControllerField("नाव", nirmandhinMothePrakalpaNaavController, context, height: 50),
                    const SizedBox(height: 5),
                    vastisarvekshanDropdown2(
                      dataModel: vastisarvekshanDropDownDataModel!,
          ...
          actions: [
            ...
            Align(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  // Map<String, dynamic> data = {
                  //   "nirmandhinMothePrakalpaID": selectednirmandhinMothePrakalpaId,
                  //   "nirmandhinMothePrakalpa": selectednirmandhinMothePrakalpaName,
                  //   "nirmandhinMothePrakalpaNaav": nirmandhinMothePrakalpaNaavController.text,
                  //   "motheVyasayikObj": selectedMasternirmandhinMothePrakalpaName,
                  // };
              ...
              return SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 10),
                    textControllerField("नाव", motheRugnalayNaavController, context, height: 50),
                    const SizedBox(height: 5),
                  ],
                ),
              );
...
//================================  15. SHAIKSHANIK SANSTHA FORM ===================================================================================================
  ...
  int? pkidSchool = 0;
  void showShaikshanikSansthaPopup(BuildContext context, {
    int? editIndex,
    VoidCallback? onDataChanged,
  }) {
        ...
        return AlertDialog(
          title: Row(
            ...
            children: [
              Text(
                        "शैक्षणिक संस्था"
                  , style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: Colors.purpleAccent)),
              IconButton(icon: Icon(Icons.close, color: Colors.grey), onPressed: () {Navigator.of(context).pop();clearShalaPrakarDataListFields();},)
            ],
          ),
          content: StatefulBuilder(
            builder: (context, setState) {
              return SingleChildScrollView(
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                  children:
                  selectedShaikshanikSansthaId == 315? [
                    vastisarvekshanDropDownDataModel != null ?
                    vastisarvekshanDropdown2(
                      dataModel: vastisarvekshanDropDownDataModel!,
                      filterTypeName: "शैक्षणिकसंस्थान",
                      hintText: "शैक्षणिक संस्था निवडा",
                      onItemSelected: (id, value,isOther) {
                    ...
                    const SizedBox(height: 5),
                    textControllerField("नाव", allShaikshanikPrakarNaavController, context, height: 50),
                    vastisarvekshanDropdown2(
                      dataModel: vastisarvekshanDropDownDataModel!,
              ...
              return SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    textControllerField("नाव", jahirKaryakramNaavControler, context, height: 50),
                    textControllerField("क्षमता", jahirKaryakramShamtaControler, context, height: 50),
                    yesNoRadioButton(
                      question: "निवासासाठी उपलब्ध",
                      onChanged: (value) {
                        if (isVastiSearch) {
                          setState(() {
                    ...
                    textControllerField("निवास क्षमता", jahirKaryakramNivasControler, context, height: 50),
                  ],
                ),
              );
            },
          ...
          actions: [
            Align(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  // Map<String, dynamic> data = {
                  //   'jahirKaryakramPrakarId': selectedJahirKaryakramId,
                  //   'jahirKaryakramPrakarName': selectedJahirKaryakramName,
                  //   'jahirKaryakramName': jahirKaryakramNaavControler.text.trim(),
                  //   'jahirKaryakramShamtaName': jahirKaryakramShamtaControler.text.trim(),
                  //   'nivasAvailable': nivasaSathiUplabdhaYesNo.toString(),
                  //   'jahirKaryakramNivasName': jahirKaryakramNivasControler.text.trim(),
                  // };
        ...
        builder: (ctx) {
          return AlertDialog(
            title: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text("वस्तीतील सामाजिक\nप्रश्न/गरजा", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: Colors.purpleAccent)),
                IconButton(icon: Icon(Icons.close, color: Colors.grey), onPressed: () {Navigator.of(context).pop();clearVastiPrashnaGarja();},)
              ],
            ),
            content: StatefulBuilder(
              builder: (context, setState) {
                return SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 5),
                      textControllerField("तपशील", vastiPrashnaGarjaTapshilController, context, height: 50),
                    ],
                  ),
                );
              },
            ...
            actions: [
              Align(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    // Map<String, dynamic> data = {
                    //   'vastiPrashnaGarjaID': selectedVastiPrashnaGarjaId,
                    //   'vastiPrashnaGarjaName': selectedVastiPrashnaGarjaName,
                    //   'vastiPrashnaGarjaTapshil': vastiPrashnaGarjaTapshilController.text.trim(),
                    // };
        ...
        builder: (ctx) {
          return AlertDialog(
            title: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text("धार्मिक नेतृत्व", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: Colors.purpleAccent)),
                IconButton(icon: Icon(Icons.close, color: Colors.grey), onPressed: () {Navigator.of(context).pop();clearDharmikNetrutva();},)
              ],
            ),
            content: StatefulBuilder(
              builder: (context, setState) {
                return SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      textControllerField("अन्य धार्मिक नेतृत्व", dharmikNetrutvaAnyaNameController, context, height: 50),
                      const SizedBox(height: 5),
                      textControllerField("नाव", dharmikNetrutvaController, context, height: 50),
                    ],
                  ),
                );
              },
  ...
  Widget _buildStep3() {
    return SingleChildScrollView(
      ...
      //=====================  SAMAJIK PRASHANA AND GARJA ================================================================
          mainContainer("वस्तीतील सामाजिक प्रश्न/गरजा",Column(
            children: [
              Row(
                mainAxisAlignment: MainAxisAlignment.end,
                children: [
                  InkWell(
                    onTap: () {
                      ...
                      if (isVastiSearch) {
                        showVastiPrashnaGarjaPopup(context,onDataChanged: () { setState(() {});});
                      } else {
                        showPopupForVastiValidation(context);
                      }
                    },
                    ...
                    child: SingleChildScrollView(
                        ...
                        child: SizedBox(
                          ...
                          child: DataTable(
                            ...
                            rows: vastiPrashnaGarjaDataList.asMap()
                                              .entries
                                              .where((entry) => entry.value.isactive == 1)
                                              .map((entry) {
                              int index = entry.key;
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                                    ...
                                    content: SingleChildScrollView(
                                      child: Column(
                                        ...
                                        children: [
                                          Divider(thickness: 1, color: Colors.deepPurple.shade100),
                                          SizedBox(height: 12),
                                          _buildInfoRow("वस्तीतील सामाजिक\nप्रश्न/गरजा", selectedData.selectedDropdownValueName),
                                          _buildInfoRow("तपशील", selectedData.name),
                                        ],
                                      ),
                                    ),
                                    actionsAlignment: MainAxisAlignment.center,
                        ...
                        SizedBox(width: 20,),
                        InkWell(
                          onTap: () {showVastiPrashnaGarjaPopup(context, editIndex: selectedVastiPrashnaGarjaIdIndex, onDataChanged: () { setState(() {});});},
                          child:Icon(Icons.edit, color: Colors.blue, size: 20),
                        ),
                        SizedBox(width: 20,),
                        InkWell(
                          onTap: () async {
                            ...
                            if (shouldDelete == true && selectedVastiPrashnaGarjaIdIndex != null) {
                              // setState(() {
                              //   vastiPrashnaGarjaDataList
                              //       .removeAt(selectedVastiPrashnaGarjaIdIndex!);
              ...
              // textControllerField("वस्तीतील सामाजिक प्रश्न(अन्य)", vastiPrashnaAnyaController, context, height: 80),
            ],
          )),
      //=====================  DHARMIK NETRUTVA  ================================================================
          mainContainer("धार्मिक नेतृत्व",Column(
            children: [
              Row(
                mainAxisAlignment: MainAxisAlignment.end,
                children: [
                  InkWell(
                    onTap: () {
                      ...
                      if (isVastiSearch) {
                        showDharmikNetrutvaPopup(context,onDataChanged: () { setState(() {});});
                      } else {
                        showPopupForVastiValidation(context);
                      }
                    },
                    ...
                    child: SingleChildScrollView(
                        ...
                        child: SizedBox(
                          ...
                          child: DataTable(
                            ...
                            headingTextStyle: TextStyle(fontWeight: FontWeight.bold,color: Colors.black87),
                            columns: const [
                              DataColumn(label: Text("धार्मिक नेतृत्व",)),
                              DataColumn(label: Text("नाव",)),
                            ],
                            rows: dharmikNetrutvaDataList.asMap()
                                              .entries
                                              .where((entry) => entry.value.isactive == 1)
                                              .map((entry) {
                              int index = entry.key;
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                                    ...
                                    content: SingleChildScrollView(
                                      child: Column(
                                        ...
                                        children: [
                                          Divider(thickness: 1, color: Colors.deepPurple.shade100),
                                          SizedBox(height: 12),
                                          _buildInfoRow("धार्मिक नेतृत्व", selectedData.selectedDropdownValueName),
                                          _buildInfoRow("अन्य धार्मिक नेतृत्व", selectedData.otherNetrutwa),
                                          _buildInfoRow("नाव", selectedData.name),
                                        ],
                                      ),
                                    ),
                        ...
                        SizedBox(width: 20,),
                        InkWell(
                          onTap: () {showDharmikNetrutvaPopup(context, editIndex: selectedDharmikNetrutvaIdIndex, onDataChanged: () { setState(() {});});},
                          child:Icon(Icons.edit, color: Colors.blue, size: 20),
                        ),
                        SizedBox(width: 20,),
                        InkWell(
                          onTap: () async {
                            ...
                            if (shouldDelete == true && selectedDharmikNetrutvaIdIndex != null) {
                              // setState(() {
                              //   dharmikNetrutvaDataList
                              //       .removeAt(selectedDharmikNetrutvaIdIndex!);
              ...
              // textControllerField("अन्य (धार्मिक)", dharmikNetrutvaAnyaController, context, height: 80),
            ],
          )),
      //=====================  DHARMIK NETRUTVA  ================================================================
