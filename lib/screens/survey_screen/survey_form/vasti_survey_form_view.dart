...
class _VastiSurveyFormScreenState extends State<VastiSurveyFormScreen> with SingleTickerProviderStateMixin {
  ...
  void setDataAfterSearch() async {
    setState(() {
      ...
      abhiyaanKaryakartaList = vastiDataByIdModel?.vastisarvekshan?.abhiyaanKaryakartaList ?? [];
                                ...
                                if (ctrl.deepestSelectedLevelId == 2)
                                  Align(
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      onPressed: () {
                                        searchVastiData(ctrl.deepestSelectedGeoUnitId);
                                        setState(() {
                                          _isExpanded = false;
                                          isVastiSearch = true;
                                        });
                  ...
                  if (_fullNameCntrl.text.isEmpty) {
                    ...
                    if (_result == 0) {
                      final newData = AbhiyaanKaryakartaModel(
                        ...
                        geounitid: int.parse(context.read<GeoHierarchyController>().deepestSelectedGeoUnitId ?? "0"),
                        isvasti: 1,
