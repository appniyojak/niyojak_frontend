...
class _MandalSurveyReportViewScreen3State extends State<MandalSurveyReportViewScreen3> {
  ...
  void getMyDetailsColumnsAndRows(String? selectedGeoUnitId) async {
    vastiSurveyReportModel = await Statics.vastisarvekshanReportData(context, Statics.userDetails["userID"], selectedGeoUnitId);
    setState(() {
    ...
    return Consumer<GeoHierarchyController>(builder: (_, ctrl, __) {
      return Column(
        children: [
                          ...
                          Align(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () {
                                ...
                                getMyDetailsColumnsAndRows(ctrl.deepestSelectedGeoUnitId);
                              },
          ...
          SizedBox(height: 10),
          if (ctrl.deepestSelectedLevelId == 3 && ctrl.deepestSelectedGeoUnitName != null && ctrl.deepestSelectedGeoUnitName != "" && isVastiSearch == true) SizedBox(height: 20),
