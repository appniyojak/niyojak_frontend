                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ChoiceChip(
                                          ...
                                          label:  Text(Statics.getLabel('Male'),style: TextStyle(color:isGender==1? Colors.white:Colors.black),),
                                          selected: isGender == 1,
                                        ...
                                        ChoiceChip(
                                          selectedColor: Colors.purple,
                                          label:  Text(Statics.getLabel('Female'),style: TextStyle(color:isGender==2? Colors.white:Colors.black),),
                                          selected: isGender == 2,
                                          onSelected: (bool selected) {
                                            setState(() {
