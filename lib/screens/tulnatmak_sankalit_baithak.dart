...
class _TulnatmakBaithakEkatritVruttaState extends State<TulnatmakBaithakEkatritVrutta> {
  ...
  Future<dynamic> _getTulnatmakEkatritVrutta(
      int baithakTypeID1,int baithakTypeID2,int? baithakTypeID3, int? geoID,
      String? tulnatmakBindu,String? bhougolikKaryasthiti, String? mahAnyEkuManBasSub,
      String? talukaSub,String? sthanSub,String? sewavruttasub,String? purnaSub,String? karyastiti,String? toliyuktasub,String? baithakkarnarya,String? vayogat,String? saptahikmilan,String? palakyukta,String? varshikotsavkarnarya) async {
  ...
  Future<void> _search() async {
    ...
    if (_baithakType1 != null && _baithakType2 != null || _baithakType3 != null) {
      ...
      if(_baithakType1 != _baithakType2 && _baithakType1 != _baithakType3 && _baithakType2 != _baithakType3) {
        ...
        try{  obj = await _getTulnatmakEkatritVrutta(_baithakType1!,_baithakType2!,_baithakType3,geoID,_tulnatmakvruttapoint,_bhougolikkaryastithisubpoint,_mahAnyEkunManBasGram,
    _talukasubpoint,_sthansubpoint,_sewavruttasubpoint,_purnasubpoint,_karyastithisubpoint,_toliyuktasubpoint,_baithakkarnaryasubpoint,_selectvayogatsubpoint,_saptahikmilansubpoint,_palakyuktasubpoint,_varshikotsavkarnaryasubpoint);
      }catch (e){
          print("_search 4");
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton:   tulnatmakBaithakResponse != null ? FloatingActionButton(
        mini: true,
...
// ================================================= Tulnatmak Bindu ==> bahugolik  =======================================================================================================================================================================================================================================================================================
                            ...
                            Text( Statics.getLabel('selectedBhougolikkaryastithi')
                              ...
                              DropdownButtonFormField<String>(
                                ...
                                onChanged: (value) {
                                  ...
                                  setState(() {
                                    ...
                                    if (value == "graam") {
                                      _mahAnyEkunManBasGramItems.removeWhere((element) =>
                                      element.value == "kimandosakha");
                                    }else if (value == "madal"){
                                      _mahAnyEkunManBasGramItems.removeWhere((element) =>
                                      element.value == "kimandosakha");
                                    }
...
// =================================================   Tulnatmak Bindu ==> bahugolik => mahanagar || anyanagar || ekunnagar || madal || basti || graam  =======================================================================================================================================================================================================================================================================================
                            if(_tulnatmakvruttapoint == "bahugolik" && _bhougolikkaryastithisubpoint == 'mahanagar' ||_bhougolikkaryastithisubpoint == 'anyanagar'||_bhougolikkaryastithisubpoint == 'ekunnagar'||_bhougolikkaryastithisubpoint == 'madal'||_bhougolikkaryastithisubpoint == 'basti'||_bhougolikkaryastithisubpoint == 'graam')
                              Text(
                                  Statics.getLabel('Type')
                                  ,style: TextStyle(color:Theme.of(context).primaryColor )),
                            if(_tulnatmakvruttapoint == "bahugolik" && _bhougolikkaryastithisubpoint == 'mahanagar' ||_bhougolikkaryastithisubpoint == 'anyanagar'||_bhougolikkaryastithisubpoint == 'ekunnagar'||_bhougolikkaryastithisubpoint == 'madal'||_bhougolikkaryastithisubpoint == 'basti'||_bhougolikkaryastithisubpoint == 'graam')
                              DropdownButtonFormField<String>(
...
// ================================================= Tulnatmak Bindu ==> bahugolik => karyastiti || toliyukta || baithak karnarya => Saptahik Milan  =======================================================================================================================================================================================================================================================================================
                            ...
                            //   SizedBox(height: 15,),
                            if (_karyastithisubpoint == "saptahikmilan" ||
                                _toliyuktasubpoint == "saptahikmilan"
                                )
...
//
                            ...
                            if(_tulnatmakvruttapoint == "karyastiti" ||_tulnatmakvruttapoint == "toliyukt"||_tulnatmakvruttapoint == "baithakkarnarya"||_tulnatmakvruttapoint == "palakyukta"||_tulnatmakvruttapoint == "varshikotsavkarnarya")
                            ...
                            if(_tulnatmakvruttapoint == "karyastiti" ||_tulnatmakvruttapoint == "toliyukt"||_tulnatmakvruttapoint == "baithakkarnarya"||_tulnatmakvruttapoint == "palakyukta"||_tulnatmakvruttapoint == "varshikotsavkarnarya")
                              ...
                              DropdownButtonFormField<String>(
                                ...
                                isExpanded: true,
                                value: _selectvayogatsubpoint == "" ? null : _selectvayogatsubpoint,
                                items: (_tulnatmakvruttapoint == "karyastiti" && (_karyastithisubpoint == "masikmilan" || _karyastithisubpoint == "sanghmandali"))
                                    ? _vayogatItems1 : _vayogatItems2,
                                onChanged: (value) {
                                  print(value);
                                  setState(() {
                                    _selectvayogatsubpoint = value;
                              ...
                              onPressed: () {
                                setState(() {
                                  mahanagarId =   _linkedMahaanagarValue = _linkedVibhaagValue =
                                      _linkedBhaagValue = _linkedShaharValue = _linkedNagarValue  = _baithakType1 =_baithakType2 =_baithakType3 = null;
                                  ...
                                  _ekatritVrutta = null;
                                  _isSearching = false;
                                  _selectedBaithak1 = '';_selectedBaithak2 = '';_selectedBaithak3 = ''; _tulnatmakvruttapoint='';  _bhougolikkaryastithisubpoint='';_mahAnyEkunManBasGram='';_selectedmahAnyEkunManBasGram =""; _talukasubpoint='';_selectedtalukasubpoint;
                                  _sthansubpoint='';_selectedsthansubpoint = "";_sewavruttasubpoint='';_selectedsewavruttasubpoint = '';_purnasubpoint='';_selectedpurnasubpoint='';_karyastithisubpoint=''; _selectvayogatsubpoint='';
                                  ;_baithakkarnaryasubpoint='';
                                  _toliyuktasubpoint='';_saptahikmilansubpoint=''; _karyastithisubpoint=''; _selectedkaryastithisubpoint='';_selectedtoliyuktasubpoint='';_selectedbaithakkarnaryasubpoint=''; _selectvayogatsubpoint='';                                     _selectedsaptahikmilansubpoint = '';
                                  _selectedvayogatsubpoint = '';_varshikotsavkarnaryasubpoint ='';_varshikotsavkarnaryasubpoint ='';
                                });
                                populatelinkedMahaanagarDropdown();
                                populatelinkedVibhaagDropdown('');
                              },
                ...
                children: [
                  ...
                  if(tulnatmakBaithakResponse != null)
                    Wrap(
                      ...
                      spacing: 8.0,
                      children: [
                        Text(_selectedcomparativevruttapoint,style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold,color: Colors.black,),),
                        if(_selectedbhougolikkaryastithisubpoint != "")
                        Text("| ${_selectedbhougolikkaryastithisubpoint}",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold,color: Colors.black,),),
                        if(_selectedmahAnyEkunManBasGram != "")
                          Text("| ${_selectedmahAnyEkunManBasGram}",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold,color: Colors.black,),),
                       if(_selectedtalukasubpoint != "")
                          Text("| ${_selectedtalukasubpoint}",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold,color: Colors.black,),),
                       if(_selectedsthansubpoint != "")
                          Text("| ${_selectedsthansubpoint}",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold,color: Colors.black,),),
                       if(_selectedsewavruttasubpoint != "")
                          Text("| ${_selectedsewavruttasubpoint}",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold,color: Colors.black,),),
                      if(_selectedpurnasubpoint != "")
                          Text("| ${_selectedpurnasubpoint}",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold,color: Colors.black,),),
                       if(_selectedkaryastithisubpoint != "")
                          Text("| ${_selectedkaryastithisubpoint}",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold,color: Colors.black,),),
                       if(_selectedtoliyuktasubpoint != "")
                          Text("| ${_selectedtoliyuktasubpoint}",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold,color: Colors.black,),),
                        if(_selectedbaithakkarnaryasubpoint != "")
                          Text("| ${_selectedbaithakkarnaryasubpoint}",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold,color: Colors.black,),),
                       if(_selectedsaptahikmilansubpoint != "")
                          Text("- ${_selectedsaptahikmilansubpoint}",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold,color: Colors.black,),),
                        if(_selectedvayogatsubpoint != "")
                          Text("| ${_selectedvayogatsubpoint}",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold,color: Colors.black,),),
                      ],
                    ),
                  SizedBox(height: 20,),
                  if(tulnatmakBaithakResponse != null)
                  Row(
                    ...
                    children: [
                      Text("बैठक क्रमांक १  :- ",style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black),),
                      Expanded(child: Text("${_baithakTypeValue1Name}  ( ${tulnatmakBaithakResponse?.baithak1a == -1 ? 0:tulnatmakBaithakResponse?.baithak1a} )",style: TextStyle(color: Colors.black),maxLines: 2,),),
                    ],
                  ),
                  if(tulnatmakBaithakResponse != null)
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("बैठक क्रमांक २  :- ",style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black),),
                      Expanded(child: Text("${_baithakTypeValue2Name}  ( ${tulnatmakBaithakResponse?.baithak2a == -1 ? 0:tulnatmakBaithakResponse?.baithak2a} )",style: TextStyle(color: Colors.black),maxLines: 2,),),
                    ],
                  ),
                  if(tulnatmakBaithakResponse != null)
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("बैठक क्रमांक ३  :- ",style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black),),
                        Expanded(child: Text("${_baithakTypeValue3Name}  ( ${tulnatmakBaithakResponse?.baithak3a == -1 ? 0 : tulnatmakBaithakResponse?.baithak3a} )",style: TextStyle(color: Colors.black),maxLines: 2,),),
                      ],
                    ),
                  if(tulnatmakBaithakResponse != null)
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("संकल्प                  :- ",style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black),),
                        Expanded(child: Text("${tulnatmakBaithakResponse?.baithak3b == -1 ? "लागू नाही" : tulnatmakBaithakResponse?.baithak3b}",style: TextStyle(color: Colors.black),maxLines: 2,),),
                      ],
                    ),
                  SizedBox(height: 20,),
                  Row(
                  ...
                  BarChartData(
                    ...
                    titlesData: FlTitlesData(
                      ...
                      bottomTitles: SideTitles(
                        showTitles: true,
                        getTitles:
                        tulnatmakBaithakResponse?.baithak3b == -1 ?
                            (double value) {
                          print(value);
  ...
  List<BarChartGroupData> _createBarGroups(List<int> counts,bool sankalpBarStatus) {
    return [
      BarChartGroupData(
        ...
        barRods: [
          BarChartRodData(
            y: counts[0].isNaN || counts[0].isInfinite ? 0.0 : counts[0].toDouble(),
      ...
      BarChartGroupData(
        ...
        barRods: [
          BarChartRodData(
            y: counts[1].isNaN || counts[1].isInfinite ? 0.0 : counts[1].toDouble(),
            colors: [Colors.blue],
            borderRadius: BorderRadius.zero,
            width: 30,
          ),
      ...
      BarChartGroupData(
        ...
        barRods: [
          BarChartRodData(
            y: counts[2].isNaN || counts[2].isInfinite ? 0.0 : counts[2].toDouble(),
            colors: [Colors.lime],
            borderRadius: BorderRadius.zero,
            width: 30,
          ),
      ...
      BarChartGroupData(
        ...
        barRods: [
          BarChartRodData(
            y: counts[5].isNaN || counts[5].isInfinite ? 0.0 : counts[5].toDouble(),colors: [Colors.purpleAccent],borderRadius: BorderRadius.zero,width: 30,
          ),
        ],
      ),
    ];
