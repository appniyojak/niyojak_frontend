...
// helper function
  ...
  Widget _numberField(
    ...
    return Padding(
      ...
      child: TextField(
        controller: controller,
        readOnly: _isSearching == false, // 🔑 typing disable when false
        onTap: () {
          if (_isSearching == false) {
            Fluttertoast.showToast(
              msg: "${Statics.getLabel('NagarSelectionImportant')}",
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return CheckboxListTile(
                              ...
                              value: selectedItems.any((e) =>
                                  e.geoUnitID ==
                                  item.geoUnitID), // ✅ check by id
                              onChanged: (bool? checked) {
                                setState(() {
                                  if (checked == true) {
                                    if (!selectedItems.any(
                                        (e) => e.geoUnitID == item.geoUnitID)) {
                      ...
                      TableRow(
                        ...
                        children: [
                          ...
                          Padding(
                              ...
                              child: Text("${Statics.getLabel('ViewMenu')}")),
                        ],
                      ),
                      TableRow(
                        children: [
                          ...
                          IconButton(
                            icon: Icon(Icons.remove_red_eye,
                                size: 22, color: Colors.purpleAccent),
                            onPressed: () {
                              // 👇 Check which object is available and open popup
                              if (selectedPerson != null) {
                                showPersonDetailsPopup(
                                    context, selectedPerson!, 1);
                              } else if (selectedPrabhavi != null) {
                                showPersonDetailsPopup(
                                    context, selectedPrabhavi!, 1);
                              }
                            },
                          ),
                        ],
              ...
              Column(
                children: [
                  ...
                  if (selectedSajjanshaktiItems.isNotEmpty) ...[
                    Text("${Statics.getLabel('SajjanShakti')}",
                  ...
                  if (selectedAnyaprabhaviItems.isNotEmpty) ...[
                    Text("${Statics.getLabel('anyaPrabhaviLok')}",
                        style: TextStyle(fontWeight: FontWeight.bold)),
                    Table(
                      border: TableBorder.all(),
                      columnWidths: const {
                        ...
                        TableRow(
                          ...
                          children: [
                            ...
                            Padding(
                                padding: EdgeInsets.all(4),
                                child: Text(
                                    "${Statics.getLabel('ViewMenu')}")), // 👁 column heading
                          ],
                        ),
                        ...selectedAnyaprabhaviItems
                            .asMap()
                        ...
                        children: [
                          ...
                          TableRow(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text("${Statics.getLabel('Vayogat')}",
                                    style: const TextStyle(
                                        fontWeight: FontWeight.bold,
                                        color: Colors.white)),
                              ),
                          ...
                          TableRow(
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Text(_rowTotal(ganShishuBaalCtrl.text,
                                        anyaShishuBaalCtrl.text)
                                    .toString()),
                              ),
                            ],
                          ),
                          ...
                          TableRow(
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Text(_rowTotal(ganMahavidyaCtrl.text,
                                        anyaMahavidyaCtrl.text)
                                    .toString()),
                              ),
                            ],
                          ),
                          ...
                          TableRow(
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Text(_rowTotal(ganTarunVyavCtrl.text,
                                        anyaTarunVyavCtrl.text)
                                    .toString()),
                              ),
                            ],
                          ),
                          ...
                          TableRow(
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Text(_rowTotal(ganProudhVyavCtrl.text,
                                        anyaProudhVyavCtrl.text)
                                    .toString()),
                              ),
                            ],
                          ),
            ...
            mainContainer(
              ...
              Column(
                children: [
                            ...
                            onSubmit:
                              ...
                              setState(() {
                                ...
                                selectedBhougolikPratinidhitwaVastiIds =
                                    selectedItems
                                        .map((e) => e.geoUnitID.toString())
                                        .join(",");
                              });
                              print(
                                  "Selected Items: ${selectedItems.map((e) => e.geoUnitID)}");
                            },
                          );
                        },
                        child: Container(
                  ...
                  SingleColumnRow(
                    txtString:
                        "${Statics.getLabel('average')} ${Statics.getLabel('pratinidhitva')} ",
                    value:
            ...
            mainContainer(
              ...
              Column(
                children: [
                              ...
                              setState(() {
                                ...
                                selectedShakhaCount = selectedItems
                                    .where(
                                        (item) => item.frequencyName == "शाखा")
                                    .length;
                                selectedShakhaaPratinidhitwaVastiIds =
                                    selectedItems
                                        .map((e) => e.geoUnitID.toString())
                                        .join(",");
                  ...
                  SingleColumnRow(
                    txtString:
                        " ${Statics.getLabel('Shaakhaa')} ${Statics.getLabel('average')} ${Statics.getLabel('pratinidhitva')} ",
            ...
            mainContainer(
              ...
              Column(
                children: [
                      ...
                      InkWell(
                        onTap: () {
                          ...
                          showMilanalistPopup(
                            ...
                            onSubmit: (selectedItems, counts) {
                              setState(() {
                                selectedMilanPratinidhitwaVastiIds =
                                    selectedItems
                                        .map((e) => e.geoUnitID.toString())
                                        .join(",");
                  ...
                  SingleColumnRow(
                    txtString:
                        " ${Statics.getLabel('SaaptaahikMilan')} ${Statics.getLabel('average')} ${Statics.getLabel('pratinidhitva')} ",
            ...
            mainContainer(
              ...
              Column(
                children: [
                  ...
                  SingleColumnRow(
                    txtString:
                        "${Statics.getLabel('milanMandali')}  ${Statics.getLabel('average')}  ${Statics.getLabel('pratinidhitva')} ",
            ...
            mainContainer(
                ...
                Column(
                  children: [
                    ...
                    SingleColumnRow(
                      txtString:
                          "${Statics.getLabel('Total')}  ${Statics.getLabel('average')}  ${Statics.getLabel('pratinidhitva')} ",
                      value: (() {
                        final total = totalShakhaCount +
                            totalMilanCount +
                            totalSanghaMandaliCount;
                        final selected = selectedShakhaCount +
                            selectedMilanCount +
                            selectedSanghaMandaliCount;
...
// ================================ Select Vasti POPUP ==================================================================
  ...
  Future<void> submitForm() async {
    Map<String, dynamic> formData = {
      ...
      "mukhya_atithi_is_sajjan_shakti":
          selectedType == "sarsajjanshakti" ? 1 : 0,
      "visitit_atithi_sajjan_shaktiids":
          selectedSajjanshaktiItems.map((e) => e.pkid.toString()).join(","),
      "visitit_atithi_anyaprabha_vi_lokamids":
          selectedAnyaprabhaviItems.map((e) => e.pkId.toString()).join(","),
      ...
      "manasik_sangh_mandali_pratinidhatva_ids":
          selectedSanghaMandaliPratinidhitwaVastiIds,
  ...
  Future<void> getFormData() async {
    ...
    String formattedJson = const JsonEncoder.withIndent('  ').convert(formData);
    log("Form Data (JSON):\n$formattedJson");
    getVijayaDashamiUtsavDataByGeounitData =
        await Statics.getVijayaDashamiUtsavDataByGeounit(context, formData);
    log("getVijayaDashamiUtsavDataByGeounitData $getVijayaDashamiUtsavDataByGeounitData");
    setState(() {
      VijayadashamiUtsav utsav =
          getVijayaDashamiUtsavDataByGeounitData!.vijayadashamiUtsav!;

      // Example text controllers
      presentMatrushaktiController.text =
          utsav.anyaUpastitiMatrushakti?.toString() ?? '';
...
//============================================   MASIKMILAN SANGHA MANDALI  pratinidhitwa =================================================================
  ...
  Future<void> showPersonDetailsPopup(
      BuildContext context, dynamic item, int srNo) {
      ...
      details = [
        ...
        {"${Statics.getLabel('special')} :": item.visheshname ?? ""},
        {
          "${Statics.getLabel('prabhavKshetra')} :":
              item.prabhaavkshetrName ?? ""
        },
        {
          "${Statics.getLabel('samparkSootraNaav')} :":
              item.samparkasutranava ?? ""
        },
        {
          "${Statics.getLabel('samparakSootraDoorbhash')} :":
              item.samparkasutraMobileNumber ?? ""
        },
      ];
    }
    ...
    // Agar Vastisanyaprabhavi ka object aaya
      ...
      details = [
        ...
        {
          "${Statics.getLabel('prabhavKshetra')} :":
              item.prabhaavKshetreName ?? ""
        },
        {
          "${Statics.getLabel('other')} ${Statics.getLabel('special')}  :":
              item.anyaVishesMahiti ?? ""
        },
        {"${Statics.getLabel('samparkStithi')} :": item.samparkSthit ?? ""},
        {
          "${Statics.getLabel('samparkSootraNaav')} :":
              item.samparkAsutraNav ?? ""
        },
        {
          "${Statics.getLabel('samparakSootraDoorbhash')} :":
              item.samparkaSutraDoorbhash ?? ""
        },
      ];
    }
