...
import 'package:niyojak_prod/dialogs/levelwise_dropdown.dart';
...
class _SewaVastiDetailsState extends State<SewaVastiDetails> {
  ...
  void initState() {
    ...
    if (sewaVastiID > 0) {
      ...
      setState(() {
        ...
        sDetails = new SewaVastiList(bhaagName: "",bhaagID: 0,graamID: "",graamName: "",mahaanagarID: 0,mahaanagarName: "",mandalID: "",mandalName: "",nagarID: 0,nagarName: "",necessarySewaTypeIDs: "",population: "",praantID: 0,remark: "",sewaVastiID: 0,sewaVastiName: "",shaharID: "",shaharName: "",vastiID: 0,vastiName: "",vibhaagID: 0,vibhaagName: "");
      });
      populateAreaDetails();
    }
  ...
  void getSewaVastiDetails(var theId) async {
    ...
    if (!isConnected) {
      ...
      String strInput = json
          .encode({"AppUserID": Statics.userDetails["userID"].toString(), "BhaagID": null, "ShaharID": null, "NagarID": null, "SewaVastiID": theId});
      var dataList = await Statics.getSewaVastiForApp(strInput);
      var data = null;

      if (dataList[0].isNotEmpty && dataList[0] != null && dataList[0].length > 0) {
          ...
          if (sDetails != null) {
            setState(() {
              ...
              if (sDetails!.vastiName != "" && sDetails!.vastiID != null) {
                print("sDetails!.vastiName");

                _isExpanded = true;
                _linkedvastiValue = sDetails!.vastiID.toString();
              } else if (sDetails!.graamName != "" && sDetails!.graamID != null) {
                print("sDetails!.graamName");

                _isExpanded = true;
                _linkedgraamValue = sDetails!.graamID.toString();
              } else if (sDetails!.mandalName == "" && sDetails!.mandalID != null) {
                print("sDetails!.mandalName");

                _isExpanded = true;
                _linkedmandalValue = sDetails!.mandalID.toString();
                populatelinkedGraamDropdown(_linkedmandalValue);
              } else if (sDetails!.nagarName == "" && sDetails!.nagarID != null) {
                print("sDetails!.nagarName");

                _isExpanded = true;
                _linkednagarValue = sDetails!.nagarID.toString();
                populatelinkedMandalDropdown(_linkednagarValue);
                populatelinkedVastiDropdown(_linkednagarValue);
              } else if (sDetails!.bhaagName != "" && sDetails!.bhaagID != null) {
                print("sDetails!.bhaagName");
  ...
  saveSwDetails() async {
    ...
    var inputData = json.encode({
      ...
      "type": type,
      "geounitid":type =="praant"?null:type =="mahanagar"?_linkedMahaanagarValue:type =="vibhag"?_linkedVibhaagValue:type == "bhag"?_linkedbhaagValue:type=="nagar"?_linkednagarValue:type =="mandal"?_linkedmandalValue:type =="gram"?_linkedgraamValue:type =="vasti"?_linkedvastiValue:null,
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(labelText: Statics.getLabel('SewaVastiName')),
