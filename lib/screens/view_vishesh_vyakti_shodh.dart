...
class ViewVisheshVyaktiScreen extends StatefulWidget {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 20),
                  buildTextField("${Statics.getLabel('OrganizationName')}",
                      sansthaNameController, TextInputType.text),
                  SizedBox(height: 20),
                  buildTextField(
                      "${Statics.getLabel('sansthetKuthalaPadavar')}",
                      sansthaPadhController,
                      TextInputType.text),
                  SizedBox(height: 20),
  ...
  Future<void> editVisheshVyakti() async {
    ...
    if (isConnected) {
      var data = {
        ...
        "SansthaType": selectedSansthaValue,
