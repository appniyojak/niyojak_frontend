...
class _SearchSShaakhaaScreenState extends State<SearchShaakhaaScreen> {
  ...
  void initState() {
    ...
    // }
    if (
    (int.parse(Statics.userDetails['LevelID']) > 1) &&
        !(
      ...
      setState(() {
        if(mandalVal ==null && graamVal == null && vastiVal == null){
          ...
          _shaakhaaList = _getshaakhaaList(
              int.parse(geoUnitIDnew!), _searchController.text, frequencyVal, vayogatVal);
        }else{
          _shaakhaaList = _getshaakhaaList(
  ...
  Future<List<dynamic>> _getshaakhaaList(int? geoUnitID, String searchString, int? frequencyID, int? vayogatID) async {
    ...
    if (isConnected) {
      String strInput =
          json.encode({"AppUserID": Statics.userDetails['userID'], "GeoUnitID": geoUnitID, "FrequencyID": frequencyID, "VayogatID": vayogatID});
        ...
        appBar: AppBar(
          ...
          actions: <Widget>[
            if (((Statics.userDetails['LevelName'] == 'Praant' ||
                ...
                Statics.userDetails['LevelName'] == 'विभाग' ||Statics.userDetails['LevelName'] == 'Praant' ||Statics.userDetails['LevelName'] == 'विभाग' || Statics.userDetails['LevelName'] == 'प्रांत' ||Statics.userDetails['LevelName'] == 'Bhaag' ||Statics.userDetails['LevelName'] == 'भाग/जिल्हा' ||
                Statics.userDetails['LevelName'] == 'Nagar/Taalukaa'  || Statics.userDetails['LevelName'] == 'Nagar' || Statics.userDetails['LevelName'] == 'Nagar/Taalukaa' || Statics.userDetails['LevelName'] == 'नगर/तालुका') &&
...
Statics.userDetails['DaayitvaName'] == 'App Sanyojak'  ||Statics.userDetails['DaayitvaName'] == 'एप संयोजक' ||
                ...
                (Statics.userDetails['LevelName'] == 'Praant' || Statics.userDetails['LevelName'] == 'प्रांत' && Statics.userDetails["DaayitvaName"] == "Join RSS Sanyojak" || Statics.userDetails["DaayitvaName"] == "जॉयन आर.एस.एस. संयोजक" ||
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      Navigator.of(context)
                          .pushNamed(EditShaakhaaScreen.routeName, arguments: Statics.ScreenArguments(0, Statics.getLabel('EditMenu')));
                    },
                  ),
                ],
              ),
                      ...
                      body: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            //   ),
                            LevelWiseDropdown(
                              onFinalSelection: (String level,String? geoUnitID) { print("geoUnitID :- $geoUnitID");
                            setState(() {
