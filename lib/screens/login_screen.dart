...
//   Map<String, String> _logInMap = {'mobileNumber': '', 'password': ''};
...
//       } else {
//         await LogIn().usrLogIn(_logInMap['mobileNumber']!, _logInMap['password']!);
...
//                       labelText: Statics.getLabel('passwordLabel')),
//                   obscureText: true,
//                   validator: (value) {
...
//                     title: Wrap(
//                       children: [
//                         if (Statics.getLabel("IAgreeToBefore") != '') Text(Statics.getLabel("IAgreeToBefore"), style: TextStyle(fontSize: 15)),
//                         InkWell(
//                             child: new Text(Statics.getLabel("TermsofUse"),
...
//                         Text(Statics.getLabel("And"), style: TextStyle(fontSize: 15)),
//                         InkWell(
//                             child: new Text(Statics.getLabel("PrivacyPolicy"),
//                                 style: TextStyle(fontSize: 15, color: Colors.blue, decoration: TextDecoration.underline)),
//                             onTap: () => launch(Statics.baseUrl + '/PrivacyPolicy.aspx')),
//                         if (Statics.getLabel("IAgreeToAfter") != '') Text(Statics.getLabel("IAgreeToAfter"), style: TextStyle(fontSize: 15)),
//                       ],
//                     ),
...
//                 else
//                   AbsorbPointer(
//                     absorbing: _isAgreed == true ? false : true,
...
//       Navigator.push(
//         context,
//         MaterialPageRoute(builder: (context) => AbhiyanEditSwayamsevakScreen()),
//       );
//     } catch (e) {
...
//     if (_phoneNumberController != null && _phoneNumberController.text.length == 10) {
...
//             Statics.showToast("Invalid Phone Number");
//           }
//         },
...
//       );
//     } else {
//       Statics.showToast("Enter valid Phone Number");
//     }
//   }
//
//   @override
...
//                         validator: (value) {
//                           if (value!.isEmpty) {
//                             return Statics.getLabel('mobileNumberValidationMessage');
//                           }
//                           return null;
//                         },
//                       ),
...
//                       //   textInputAction: TextInputAction.next,
//                       //   decoration: InputDecoration(
//                       //     labelText: Statics.getLabel('oTPLabel'),
//                       //   ),
//                       //   keyboardType: TextInputType.phone,
//                       //   validator: (value) {
//                       //     if (value!.isEmpty) {
//                       //       return Statics.getLabel('oTPValidationMessage');
//                       //     }
//                       //     return null;
//                       //   },
//                       // ),
