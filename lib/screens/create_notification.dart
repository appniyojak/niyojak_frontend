...
class _CreateNotificationViewState extends State<CreateNotificationView> {
  ...
  Future<void> populateDropdown() async {
    ...
    print("geoUnitId ${_linkedvastiValue ?? _linkedgraamValue ?? _linkedmandalValue ?? _linkednagarValue ?? _linkedshaharValue ?? _linkedbhaagValue ?? _linkedVibhaagValue ?? _linkedMahaanagarValue}");

    setState(() {
      geoUnitId = _linkedvastiValue ?? _linkedgraamValue ?? _linkedmandalValue ?? _linkednagarValue ?? _linkedshaharValue ?? _linkedbhaagValue ?? _linkedVibhaagValue ?? _linkedMahaanagarValue;
      _daayitvaFor = data4;
      _level = data5;
  ...
  void onSubmit(String? messageCustom, String? type, List<DaayitvaMasterBAL> selectedDayitvaSubType, List<dynamic> selectedSanghaPreritSanstha) {
                              ...
                              children: [
                                ...
                                MultiSelectDialogField(
                                  items: [
                                    ...
                                    ..._daayitvaFor!.where((e) => e.codeForDisplay != "${Statics.getLabel('OtherSocialOrganization')}").map((e) => MultiSelectItem(e, e.codeForDisplay!)).toList(),
                                  ],
                                  title: Text("${Statics.getLabel('SelectDaayitvaFor')}"),
                                  selectedColor: Colors.purple,
                                  buttonText: Text("${Statics.getLabel('SelectDaayitvaFor')}"),
                                  ...
                                  onConfirm: (values) async {
                                    setState(() {
                                      if (values.contains("all")) {
                                        _selectedDaayitvaFor = _daayitvaFor!.where((e) => e.codeForDisplay != "${Statics.getLabel('OtherSocialOrganization')}").toList();
                                      } else {
                                        _selectedDaayitvaFor = values.cast<StaticMasterBAL>();
                                      }
                                      _selectedDayitvaItems = [];
                  ...
                  MaterialButton(
                    ...
                    onPressed: () async {
                      if (customMessageController.text == "") {
                        ...
                        onSubmit(customMessageController.text, type, _selectedDayitvaItems, _selectedPreritSanstha);
                      }
                    },
                    child: Text(
