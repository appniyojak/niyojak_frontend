class JoinRssListModel {
  List<ListJoinRSS>? listJoinRSS;
  List<ListJoinRSSByStatus>? listJoinRSSByStatus;
  String? message;
  String? status;

  JoinRssListModel(
      {this.listJoinRSS, this.listJoinRSSByStatus, this.message, this.status});

  JoinRssListModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['ListJoinRSSByStatus'] != null) {
      listJoinRSSByStatus = <ListJoinRSSByStatus>[];
      json['ListJoinRSSByStatus'].forEach((v) {
        listJoinRSSByStatus!.add(new ListJoinRSSByStatus.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.listJoinRSSByStatus != null) {
      data['ListJoinRSSByStatus'] =
          this.listJoinRSSByStatus!.map((v) => v.toJson()).toList();
    }
...
class ListJoinRSSByStatus {
  int? femaleCountByStatus;
  int? maleCountByStatus;
  String? statusCode;
  int? statusID;

  ListJoinRSSByStatus(
      {this.femaleCountByStatus,
        this.maleCountByStatus,
        this.statusCode,
        this.statusID});

  ListJoinRSSByStatus.fromJson(Map<String, dynamic> json) {
    femaleCountByStatus = json['FemaleCountByStatus'];
    maleCountByStatus = json['MaleCountByStatus'];
    statusCode = json['StatusCode'];
    statusID = json['StatusID'];
  }
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['FemaleCountByStatus'] = this.femaleCountByStatus;
    data['MaleCountByStatus'] = this.maleCountByStatus;
    data['StatusCode'] = this.statusCode;
    data['StatusID'] = this.statusID;
    return data;
  }
